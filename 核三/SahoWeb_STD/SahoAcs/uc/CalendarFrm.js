...
function Call_CalendarByDay(objText) {
    target_obj = objText;
    var obj = document.getElementById(objText);
    var sPara = obj.value;
    /*
    var sRet = window.showModalDialog('/DialogBox/SelectDateTime.aspx', sPara, "dialogHeight:320px; dialogWidth:260px; center: Yes; help: No; resizable: No; scroll: No");
    ...
    */
    ...
    $.post("../../../DialogBox/DateSelect.aspx", {
        para_date: sPara
    }, function (data) {
        //$('<div id="dvContent" style="position:absolute;left:20px;top:30px;z-index:1000000000'
        //   + ';background-color: #2D89EF; border-color: #818181; border-width: 1px; border-style: solid;" ></div>').appendTo(document);
