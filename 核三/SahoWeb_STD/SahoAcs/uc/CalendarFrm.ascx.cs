...
{
    public partial class CalendarFrm : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Clock.Attributes.Add("OnClick", "Call_CalendarByDay('" + this.CalendarTextBox.ClientID.ToString() + "'); return false;");
                CalendarTextBox.Attributes.Add("OnClick", "Call_CalendarByDay('" + this.CalendarTextBox.ClientID.ToString() + "'); return false;");
