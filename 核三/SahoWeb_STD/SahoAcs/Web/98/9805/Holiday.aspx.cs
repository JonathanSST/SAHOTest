...
namespace SahoAcs
{
    public partial class Holiday : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("Holiday", "Holiday.js");//加入同一頁面所需的JavaScript檔案
            ...
            if (dr.Read())
            {
                ...
                while (ParaValueStr.Length > 0)
                {
                    ...
                    td.Text =this.GetLocalResourceObject("mon"+ParaValueStr.Substring(0, 2)).ToString()
                        + int.Parse(ParaValueStr.Substring(2, 2)) + this.GetLocalResourceObject("dayTh").ToString();
                    td.ID = "HolidayTD" + ParaValueStr.Substring(0, 4);
                    td.Attributes.Add("OnClick", "onSelect('" + td.ClientID + "','" + ParaValueStr.Substring(0, 4) + "')");
        ...
        public static object Add(string UserID, string ParaValue)
        {
            ...
            if (!string.IsNullOrEmpty(ParaValue))
                ParaValue = ParaValue.Replace("/", "").Substring(4, 4);
            ...
            if (dr.Read())
            {
                ...
                while (ParaValueStr.Length > 0)
                {
                    ParaValueList.Add(ParaValueStr.Substring(0, 4));
                    ParaValueStr = ParaValueStr.Substring(4);
                }
        ...
        private void SetHolidayCode()
        {
            ...
            string str_cmd2 = @"UPDATE B01_EquParaData 
                                                            ...
                                                            AND EquID IN (SELECT EquID FROM B01_EquData WHERE EquModel NOT LIKE 'ADM100%')";
            ...
            string str_cmd3 = @"UPDATE B01_EquParaData 
                                                            ...
                                                            AND EquID IN (SELECT EquID FROM B01_EquData WHERE EquModel LIKE 'ADM100%')";
