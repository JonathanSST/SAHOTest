...
{
    public partial class ImportPsnData : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("MainJs", "ImportPsnData.js?" + Pub.GetNowTime); //加入同一頁面所需的JavaScript檔案
