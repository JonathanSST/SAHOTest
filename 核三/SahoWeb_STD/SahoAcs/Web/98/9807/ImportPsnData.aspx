<%@ Page  Title="" Theme="UI"  Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="ImportPsnData.aspx.cs" Inherits="SahoAcs.Web._98._9807.ImportPsnData" %>
        ...
        <tr>
            <td>
                <fieldset id="PsnCard_List" runat="server">
                    <legend id="PsnCard_Legend" runat="server" >休假憑證匯入</legend>
                    <table class="Item">
                        <tr>
                            <td>                                
                            ...
                            <td>                                
                                <input type="button" value="匯入休假資料" id="BtnImport" style="font-size:small;color:aliceblue" name="BtnImport" onclick="UploadFileAsync()" class="IconImport" />
