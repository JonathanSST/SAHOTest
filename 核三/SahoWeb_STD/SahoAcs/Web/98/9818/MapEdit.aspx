<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MapEdit.aspx.cs" Inherits="SahoAcs.Web._98._9818.MapEdit" %>
...
<div>
        <table>
            <tbody>
                ...
                <tr>
                    <td style="text-align: center" colspan="2">                              
                        <input type="button" id="btnSave" value="<%=this.GetGlobalResourceObject("Resource","btnOK") %>" class="IconSave" />
