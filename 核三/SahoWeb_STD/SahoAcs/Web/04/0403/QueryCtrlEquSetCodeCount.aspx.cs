...
namespace SahoAcs
{
    public partial class QueryCtrlEquSetCodeCount : System.Web.UI.Page
    {
        #region 一.宣告
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CreateQueryCtrlEquSetCodeCountPageComponent();
            SetDDLLocItemList();
        ...
        private void RegisterComponeAndScript()
        {
            ...
            ClientScript.RegisterClientScriptInclude("QueryCtrlEquSetCodeCountScript", "QueryCtrlEquSetCodeCount.js?jsdate=" + DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
            #endregion
        }
        ...
        /// 建立設備設碼筆數查詢網頁的相關元件
        /// </summary>
        private void CreateQueryCtrlEquSetCodeCountPageComponent()
        {
            DB_Acs oAcsDB = null;
            DataTable dt = null;
