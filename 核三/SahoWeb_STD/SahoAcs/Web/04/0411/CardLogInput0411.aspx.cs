...
{
    public partial class CardLogInput0411 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("CardLogInput", "CardLogInput0411.js"); //加入同一頁面所需的JavaScript檔案
            #endregion
            ...
            //btnEdit.Attributes["onClick"] = "CallEdit(''); return false;";
            #endregion
        ...
        public void GridView_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            switch (e.Row.RowType)
            {
                ...
                case DataControlRowType.DataRow:
                    ...
                    e.Row.Attributes.Add("OnDblclick", "CallEdit('" + oRow.Row["CardID"].ToString() + "')");
