...
namespace SahoAcs
{
    public partial class QueryCtrlEquRealtimeOnlineState : System.Web.UI.Page
    {
        #region 一.宣告
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CreateQueryCtrlEquRealtimeOnlineStatePageComponent();
            SetDDLLocItemList();
        ...
        private void RegisterComponeAndScript()
        {
            ...
            ClientScript.RegisterClientScriptInclude("QueryCtrlEquRealtimeOnlineStateScript", "QueryCtrlEquRealtimeOnlineState.js?jsdate=" + DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
            #endregion
        }
        ...
        /// 建立設備即時連線狀態網頁的相關元件
        /// </summary>
        private void CreateQueryCtrlEquRealtimeOnlineStatePageComponent()
        {
            DB_Acs oAcsDB = null;
            DataTable dt  = null;
