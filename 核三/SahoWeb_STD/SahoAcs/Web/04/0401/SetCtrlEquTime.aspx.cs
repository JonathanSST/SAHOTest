...
namespace SahoAcs
{
    public partial class SetCtrlEquTime : System.Web.UI.Page
    {
        #region 一.宣告
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CreateSetCtrlEquTimePageComponent();
            SetDDLLocItemList();
        ...
        private void RegisterComponeAndScript()
        {
            ...
            ClientScript.RegisterClientScriptInclude("SetCtrlEquTimeScript", "SetCtrlEquTime.js?jsdate=" + DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
        ...
        /// 建立設定控制器時間網頁的相關元件
        /// </summary>
        private void CreateSetCtrlEquTimePageComponent()
        {
            DB_Acs oAcsDB = null;
            DataTable dt = null;
