<%@ Page Language="C#" CodeBehind="SetSersorMode.aspx.cs" Inherits="SahoAcs.SetSersorMode" MasterPageFile="~/Site1.Master" Debug="true" AutoEventWireup="True" EnableEventValidation="false" Theme="UI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table class="Item">
                ...
                <tr>
                    <td style="width: 140px">
                        <asp:DropDownList ID="ddlCtrlModel" runat="server" Width="90%" CssClass="DropDownListStyle" EnableViewState="False" BackColor="#FFE5E5" Font-Bold="True">
                        </asp:DropDownList>
                    </td>
                    <%--  <td>
                        <asp:Panel ID="popPanel0_CtrlModel" runat="server" Width="140px"></asp:Panel>
                    </td>--%>
                    <td style="width: 140px">
                    ...
                    <td id="td_showGridView" runat="server" style="padding: 0">
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight">
                            ...
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" Width="100%" PageSize="10"
                                DataKeyNames="SenID" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SenID" HeaderText="<%$Resources:ResourceCtrls,SerialKey %>" SortExpression="SenID" />
                                    <asp:BoundField DataField="IOMNo" HeaderText="IO模組編號" SortExpression="IOMNo" />
                                    <asp:BoundField DataField="SenNo" HeaderText="偵測器編號" SortExpression="SenNo" />
                                    <asp:BoundField DataField="SenName" HeaderText="偵測器名稱" SortExpression="SenName" />
                                    <asp:BoundField DataField="LocLongName" HeaderText="位置" SortExpression="LocLongName" />
                                    <asp:BoundField DataField="RowStatus" HeaderText="目前狀態" SortExpression="RowStatus" />
                                    <%--<asp:TemplateField>
                                        <HeaderTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <table style="padding-top: 10px" class="Item">
                <tr>
                    <%-- <td>
                    ...
                    <th>
                        <asp:RadioButton ID="SenStatus_1" runat="server" Text="啟用" value="1" GroupName="SenStatus" Width="60px" Checked="True" /></th>
                    <th>
                        <asp:RadioButton ID="SenStatus_0" runat="server" Text="停用" value="0" GroupName="SenStatus" Width="60px" /></th>
                    <th>
                        <asp:RadioButton ID="SenStatus_2" runat="server" Text="限制" value="2" GroupName="SenStatus" Width="60px" /></th>
                    <td>
                        <asp:Button ID="SetButton" runat="server" Text="設 定" CssClass="IconSet" OnClick="SetButton_Click" /></td>
    ...
    <%--    <asp:Panel ID="PanelPopup0" runat="server" SkinID="PanelPopup" Width="450px" EnableViewState="False" CssClass="PopBg">
        <asp:Panel ID="PanelDrag0" runat="server" SkinID="PanelDrag" EnableViewState="False">
            <table class="TableWidth">
                <tr>
                    <td>
                        <span id="L_popName0" style="color: White; font-weight: bold; vertical-align: middle">
                            <%=GetGlobalResourceObject("ResourceCtrls","ttAdvance").ToString() %>
                        </span>
                    </td>
    ...
    <%--    <asp:Panel ID="PanelPopup1" runat="server" SkinID="PanelPopup" Width="450px" EnableViewState="False" CssClass="PopBg">
        <asp:Panel ID="PanelDrag1" runat="server" SkinID="PanelDrag" EnableViewState="False">
            <table class="TableWidth">
                <tr>
                    <td>
                        <span id="L_popName1" style="color: White; font-weight: bold; vertical-align: middle">
                            <%=GetGlobalResourceObject("ResourceCtrls","ttViewer").ToString() %>
                        </span>
                    </td>
                    <td style="text-align: right;">
