...
namespace SahoAcs
{
    public partial class QueryCtrlEquTime : System.Web.UI.Page
    {
        #region 一.宣告
        ...
        private void RegisterComponeAndScript()
        {
            ...
            ClientScript.RegisterClientScriptInclude("QueryCtrlEquTimeScript", "QueryCtrlEquTime.js?jsdate=" + DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
            #endregion
        }
