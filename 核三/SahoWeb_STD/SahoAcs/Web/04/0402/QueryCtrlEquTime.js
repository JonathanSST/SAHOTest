...
//        if (document.forms[0][i].name.split('$')[4] == "RowCheckState") {
//            document.forms[0].elements[i].checked = HeaderCheckState.checked;
//        }
//    }
...
//        for (var i = 0; i < GVRCheckStateArray.length; i += 2) {
//            GVRCheckStateList = GVRCheckStateList.replace(Key0, Key1);
//        }
