<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CardLogFillManage.aspx.cs" Inherits="SahoAcs.CardLogFillManage" %>
                ...
                <table>
                    <tr>
                        <th colspan="3">
                            ...
                            <asp:Label ID="Label1" runat="server" Text="開課日期區間"></asp:Label>
                        </th>
                        <th>
                            <span class="Arrow01"></span>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" name="ButtonAdd" value="新增補登記錄" id="ButtonAdd" class="IconNew" tabindex="0" onclick="SetAdd()" />
                        </td>
                    </tr>
                </table>
            </td>
