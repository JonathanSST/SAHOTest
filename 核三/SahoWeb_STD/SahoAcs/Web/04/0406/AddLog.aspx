<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddLog.aspx.cs" Inherits="SahoAcs.Web._04._0406.AddLog" %>
<%@ Register Src="/uc/Calendar.ascx" TagName="Calendar" TagPrefix="uc1" %>
<%@ Register src="../../../uc/NewCalendar.ascx" tagname="NewCalendar" tagprefix="uc2" %>
                ...
                <td>
                    <table>
                        <tr>
                            <th colspan="1">
                                <span class="Arrow01"></span>
                                <asp:Label ID="popLabel_CardTime" runat="server" Text="讀卡時間" Font-Bold="true"></asp:Label>
                            </th>
                        </tr>
                        <tr>
