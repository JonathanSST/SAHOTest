...
{
    public partial class ClassScheduleReport : SahoAcs.DBClass.BasePage
    {
        ...
        {
           //查詢組織相關資料
            this.OrgDataInit = this.od.GetQueryResult<SahoAcs.DBModel.OrgDataEntity>("SELECT * FROM OrgStrucAllData('Unit') WHERE OrgNo<>''").ToList();
            ...
            this.ClassAllList.Add("C");
            this.ClassAllList.Add("R");
            Date1 = DateTime.Parse(NowMonth + "/26");
            Date1 = Date1.AddMonths(-1);
            Date2 = DateTime.Parse(NowMonth + "/25");
        }
        ...
        private void SetClassList()
        {
            ...
            string sqlMainCmd = @" SELECT TOP 300 A.* from B01_Person A
            ...
            Date1 = DateTime.Parse(Request.Form["ClassMonth"] + "/26");
            Date1 = Date1.AddMonths(-1);
            Date2 = DateTime.Parse(Request.Form["ClassMonth"] + "/25");
