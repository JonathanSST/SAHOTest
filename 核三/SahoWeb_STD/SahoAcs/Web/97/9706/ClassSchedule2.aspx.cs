...
{
    public partial class ClassSchedule2 : SahoAcs.DBClass.BasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("JsFun", "ClassSchedule2.js?"+Pub.GetNowTime);//加入同一頁面所需的JavaScript檔案
