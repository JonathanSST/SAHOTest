<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CancelMeal.aspx.cs" Inherits="SahoAcs.Web._07._0705.CancelMeal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <th>
                <fieldset id="KeyIn" runat="server" style="width: 1200px">
                     <legend id="PsnCard_Legend" runat="server">用餐取消</legend>
                <table class="Item">
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                         <span class="Arrow01"></span>
                            <asp:Label ID="Label_OrderDate" runat="server" Text="取消日"></asp:Label>
                        </th>
                        <th>
   ...
   <div style="text-align:center;">
        <input type="button" class="IconEdit" value="確    定" id="BtnCancel" onclick="Cancel();" />
    </div>
</asp:Content>
