<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DiningRecordInq.aspx.cs" Inherits="SahoAcs.Web._07._0703.DiningRecordInq" %>
      ...
      <table class="Item">
        ...
        <tr>
           <td colspan="3" style="font-size: 16px; color: white">
             ...
             <td colspan="3" style="font-size: 16px; color: white">
                 資料來源
                 <asp:DropDownList ID="dropOrderSrc" runat="server" Width="200px">
                    <asp:ListItem Value="" Selected="True">== 全部 ==</asp:ListItem>
                      <asp:ListItem Value="1" >刷卡</asp:ListItem>
                      <asp:ListItem Value="5" >補登</asp:ListItem>
            ...
            <td colspan="2" align="right">
                ...
                <input type="button" class="IconExport" name="ExportXlsButton" value="匯出Excel" id="ExportXlsButton" onclick="SetPrintExcel();" />
            </td>
        </tr>
        </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">          
                                            <td style="width:154px">
                                             <%string ProcTime = "";
                                                        if (o.ProcTime.Equals(DateTime.MinValue))
                                                        {
                                                            ProcTime = "查無資料";
                                                        }
                                                        else 
                                                        {
                                                            ProcTime = Convert.ToString(o.ProcTime);
                                                        }                                                                                                      
                                                         %>
                                                    <%=ProcTime %>
                                               <%--<%=o.OrderTime %>--%>
