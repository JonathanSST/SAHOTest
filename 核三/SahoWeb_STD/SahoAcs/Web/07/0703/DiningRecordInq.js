...
function SetQuery() {
    ...
    var MealNo = $("#ContentPlaceHolder1_dropMealNo").val();
    var MealFood = $("#ContentPlaceHolder1_dropMealFood").val();
    var OrderSrc = $("#ContentPlaceHolder1_dropOrderSrc").val();
...
function SetPrintExcel() {
    ...
    $("#Dep").val(Dep);
    $("#MealNo").val(MealNo);
    $("#MealFood").val(MealFood);
    $("#OrderSrc").val(OrderSrc);
