...
namespace SahoAcs.Web._07._0706
{
    public partial class QueryHolidayDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("jsfun", "QueryHolidayDetail.js?" + Pub.GetNowTime);//加入同一頁面所需的JavaScript檔案
        ...
        private void Export()
        {
            ...
            if (this.ListLog.Count > 0)
            {
                ...
                foreach (var p in OrgNoList)
                {
                    ...
                    sb.Append(string.Format("<table style='width:100%;font-size:10pt'><tr><td style='width:50%'>部門名稱代號：{1}  {0}</td></tr></table>", p, OrgName));
