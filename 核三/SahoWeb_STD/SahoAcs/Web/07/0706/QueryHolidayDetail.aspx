<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryHolidayDetail.aspx.cs" Inherits="SahoAcs.Web._07._0706.QueryHolidayDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="Item">
        <tr>
            ...
            <th>
                <span class="Arrow01"></span>
                <asp:Label ID="lblDepartment" runat="server" Text="單位"></asp:Label>
            </th>
            <th colspan="3">
                <span class="Arrow01"></span>
