<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"  CodeBehind="AttendLogInq.aspx.cs" Inherits="SahoAcs.Web._07._0701.AttendLogInq" %>
     ...
     <table class="Item">
        ...
        <tr>
           <td colspan="3" style="font-size: 16px; color: white">
                查詢的依據
            <asp:RadioButtonList ID="rdb_byTime" runat="server" RepeatColumns="2"  RepeatDirection="Horizontal" RepeatLayout="Flow" Width="250px" Font-Size="Small" ForeColor="White">
                <asp:ListItem Value="byReceiveTime" >依接收時間</asp:ListItem>
                <asp:ListItem Value="byLogTime" Selected="True" >依刷卡時間</asp:ListItem>
            </asp:RadioButtonList>
           </td>
             <td class="ShowPsnInfo">
                <asp:CheckBox ID="chk_EmpCardNo" runat="server"  Text="菱生之人員" Font-Size="Small" ForeColor="White"></asp:CheckBox>                 
             </td> 
             <td colspan="4" align="right">
                ...
                <input type="button" name="ExportTxtButton" value="匯出文字檔" id="ExportTxtButton" class="IconExport" onclick="SetPrintTxt();" />
