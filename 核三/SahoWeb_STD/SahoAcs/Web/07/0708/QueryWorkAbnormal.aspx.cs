...
namespace SahoAcs.Web._07._0708
{
    public partial class QueryWorkAbnormal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("jsfun", "QueryWorkAbnormal.js?" + Pub.GetNowTime);//加入同一頁面所需的JavaScript檔案
        ...
        private void Export()
        {
            ...
            if (this.ListLog.Count > 0)
            {
                ...
                foreach (var p in PsnNoList)
                {
                    ...
                    sb.Append("<div style='width:100%;text-align:center;font-size:14pt'>差　勤　紀　錄　異　常　表</div>");
            ...
            Response.AddHeader("content-disposition", "attachment;filename=差勤紀錄異常表.pdf");
            Response.End();
        }
