...
<%@ Page Language="C#" CodeBehind="TempCardRecordWithArea.aspx.cs" Inherits="SahoAcs.TempCardRecordWithArea" MasterPageFile="~/Site1.Master" Debug="true" AutoEventWireup="true" EnableEventValidation="false" Theme="UI" %>
                                    ...
                                    <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" Height="250">
                                        ...
                                        <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="AreaName" HeaderText="廠區" SortExpression="AreaName" />
            ...
            <tr>
                <td>
                    <table>
                        ...
                        <tr>
                            <th>
                                <asp:Label ID="Label1" runat="server" Text="廠區" Font-Bold="true"></asp:Label>
                            </th>
                            <th>                                
                            </th>
                        </tr>
