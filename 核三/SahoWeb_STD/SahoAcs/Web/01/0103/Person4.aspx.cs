...
namespace SahoAcs
{
    public partial class Person4 : System.Web.UI.Page
    {
        ...
        private void LoadProcess()
        {
            ...
            ClientScript.RegisterClientScriptInclude("Person", "Person4.js"); //加入同一頁面所需的JavaScript檔案
        ...
        protected static Pub.MessageObject Check_Input_DB(string[] NoArray, string mode)
        {
            ...
            if (mode == "Insert")
            {
                ...
                {
                    sRet.result = false;
                    sRet.message += "人員編號格式錯誤!!必須為身份證號格式";
                }
                    ...
                    if (oAcsDB.Commit())
                    {
                        ...
                        if (oAcsDB.GetDataReader(sql, liSqlPara, out oReader))
                        {
                            if (oReader.HasRows)
                            {
                                ...
                                string CardNo = Pub.GetIDToCard(sPsnNo) + sCardVer ;
        ...
        {            
            ...
            List<string> liSqlPara = new List<string>();
            OrmDataObject odo = new OrmDataObject("MsSql",Pub.GetDapperConnString());
            var NewCardNo = sCardNo.Substring(0, 11) + sCardVer;
