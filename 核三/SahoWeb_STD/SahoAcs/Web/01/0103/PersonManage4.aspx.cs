...
{
    public partial class PersonManage4 : BasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (Request["PageEvent"] == "Save")
            {
                ...
                var BooDblPsn = false;
                BooDblPsn = this.GetDblPsnNo();
                if (Request["PsnID"] == "0")
                {
                    //新增B01_Person                    
                    if (!BooDblPsn && !this.GetDblCardNo())
                    {
                        this.DoInsert();
                        //新增人員完成
            ...
            else
            {
                ...
                ClientScript.RegisterClientScriptInclude("Person", "PersonManage4.js?" + Pub.GetNowTime); //加入同一頁面所需的JavaScript檔案
        ...
        {           
            ...
            this.odo.Execute(@"INSERT INTO B01_Person 
                    (PsnPicSource,PsnNo,PsnName,PsnEName,PsnType,IDNum,Birthday,OrgStrucID,PsnAccount,PsnPW, PsnAuthAllow,PsnSTime,PsnETime,Remark,VerifiMode,CreateTime,CreateUserID,UpdateTime,UpdateUserID,Text5,Text1,Text2,Text3,Text4,Personal,Supervisor) 
                    VALUES ('',@PsnNo,@PsnName,@PsnEName,@PsnType,@IDNum,@BirthDay,@OrgStrucID,@PsnAccount,@PsnPW
                    ,@PsnAuthAllow,@PsnSTime,@PsnETime,@Remark,@VerifiMode,GETDATE(),@CreateUserID,GETDATE(),@UpdateUserID,@Text5,@Text1,@Text2,@Text3,@Text4,@Personal,@Supervisor) ", this.PersonObj);
        ...
        private void DoUpdate()
        {
            ...
            UpdateCmd += ",Personal=@Personal,Supervisor=@Supervisor ";
        ...
        private void SetObjData()
        {
            ...
            ListCols.Add("Text2");
            ListCols.Add("Text1");
            ListCols.Add("Personal");
            ListCols.Add("Supervisor");
