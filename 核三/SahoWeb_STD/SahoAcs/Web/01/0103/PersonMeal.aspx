<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PersonMeal.aspx.cs" Inherits="SahoAcs.PersonMeal" Debug="true" EnableEventValidation="false" Theme="UI" %>
                ...
                <fieldset id="Pending_List" runat="server"  style="height:610px">
                    ...
                    <table class="Item">
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 250px;">
                                <div>
                                    <asp:Label ID="lblMealFood" runat="server" Text="葷素食："></asp:Label>
                                </div>
                                <div>
                                    <asp:DropDownList ID="Input_MealFood" runat="server" Width="80px">
                                        <asp:ListItem Value="0" Selected="True"  Text="葷"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="素"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div>
