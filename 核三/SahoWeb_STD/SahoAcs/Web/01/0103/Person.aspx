<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Person.aspx.cs" Inherits="SahoAcs.Person" Debug="true" EnableEventValidation="false" Theme="UI" %>
    ...
    <table class="Item">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="button" value="<%=Resources.Resource.btnExport %>" class="IconExport" onclick="ExportData()" />
                    ...
                    <table class="Item">
                        <tr>
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    <asp:TextBox ID="Input_PsnNo" runat="server" Width="180px" MUST_KEYIN_YN="Y" FIELD_NAME="人員編號"></asp:TextBox>
                                </div>
                                <div>
                                    <asp:Label ID="lb_PsnName" runat="server" Text="<%$ Resources:lblPsnName %>"></asp:Label>
                                </div>
                                <div>
                                    <asp:TextBox ID="Input_PsnName" runat="server" Width="180px" MUST_KEYIN_YN="Y" FIELD_NAME="人員姓名"></asp:TextBox>
                                </div>
                                <div>
                            ...
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    <asp:Label ID="lblTrainingEDate" runat="server" Text="<%$ Resources:lblTrainingEDate %>"></asp:Label>
                                </div>
                                <div>
                                    <uc1:Calendar ID="Input_TrainingEDate" runat="server" />
                                </div>
                                ...
                                <%} %>
                                <div>
                                    <asp:Label ID="lblCardRule" runat="server" Text="<%$ Resources:lblCardRule %>"></asp:Label>
                                </div>
                                <div>
                                    <asp:DropDownList ID="Input_CardRule" runat="server">
                                        <asp:ListItem Value="0" Text="<%$Resources:SelectNO %>"></asp:ListItem>
                                        <asp:ListItem Value="1" Selected="True" Text="<%$Resources:SelectYES %>"></asp:ListItem>

                                    </asp:DropDownList>
                                </div>
                                <div>
                                    <asp:Label ID="lblCardLock" runat="server" Text="<%$ Resources:lblCardLock %>"></asp:Label>
                                </div>
                                <div>
                                    <asp:DropDownList ID="Input_CardLock" runat="server">
                                        <asp:ListItem Value="0" Selected="True" Text="<%$Resources:SelectNO %>"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="<%$Resources:SelectYES %>"></asp:ListItem>
                            ...
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    <asp:TextBox ID="Input_CardVer" runat="server" Width="90px" MaxLength="1" Text="0"></asp:TextBox>
                                </div>
                                ...
                                <div>
                                    <asp:ListBox ID="List_CardInfo" runat="server" Height="50px" Width="200px" SkinID="ListBoxSkin"></asp:ListBox>
                                </div>
                                <div>
                                    <p style="height: 3px">&nbsp;</p>
                                    ...
                                    <p style="height: 3px">&nbsp;</p>
                                    <input type="button" class="IconChange" value="<%=GetLocalResourceObject("btnCardVerChange") %>" id="btnChange" name="btnChange" onclick="ChangeCardVer(1)" />
                                    <p style="height: 3px">&nbsp;</p>
                                    <input type="button" class="IconSet" value="<%=GetLocalResourceObject("btnPic") %>" id="btnPic" name="btnPic" onclick="UploadPicSource()" />
                                     <p style="height: 3px">&nbsp;</p>
                                     <asp:Button ID="btnMakeCard" runat="server" Text="<%$ Resources:btnMakeCard %>" CssClass="IconNew" />
                                    </div>
                            </td>
