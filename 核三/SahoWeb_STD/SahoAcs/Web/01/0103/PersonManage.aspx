<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Theme="UI" CodeBehind="PersonManage.aspx.cs" Inherits="SahoAcs.Web.PersonManage" %>
                        ...
                        <table class="Item">
                            <tr>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <input type="text" name="<%=Convert.ToString(o.ParaNo).Replace("Input_","")  %>" id="<%=Convert.ToString(o.ParaNo).Replace("Input_","")  %>" value="<%=o.ParaValue %>" style="width:180px"/>
                                    </div>
                                    <%} %>
                                    <div>
                                    ...
                                    <%if (this.PersonObj.TravelMode != 0)
                                        { %>
                                    <div>
                                    <span id="TravelModeType">油資補助類型</span>
                                    <select name="TravelMode" id="TravelMode" class="DropDownListStyle" style="width: 80px;">
                                        <%foreach (var o in this.DictTravel)
                                        { %>
                                        <%if (PersonObj.TravelMode == o.Key)
                                                { %>
                                        <option selected="selected" value="<%=o.Key %>"><%=o.Value %></option>
                                        <%}
                                                else
                                                { %>
