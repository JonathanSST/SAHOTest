...
namespace SahoAcs
{
    public partial class PersonImport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("PersonImport", "PersonImport.js");//加入同一頁面所需的JavaScript檔案
        ...
        protected void PsnCard_ImportButton_Click(object sender, EventArgs e)
        {
            ...
            if (PsnCardCorrectFlag && PsnTableCount > 0)
            {
                ...
                if (iRet > -1)
                {
                    sSql = @" INSERT INTO B01_Person(PsnNo, PsnName, PsnEName, PsnType, IDNum, Birthday, OrgStrucID, PsnAccount, PsnPW, PsnAuthAllow, PsnSTime, PsnETime, PsnPicSource, CreateUserID, CreateTime)
                              SELECT 
