<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CardEquAdj4.aspx.cs" Inherits="SahoAcs.CardEquAdj4" Debug="true" EnableEventValidation="false" Theme="UI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="Item">
        <tr>
            <th>
                ...
                <asp:DropDownList ID="ddl_input" runat="server" Width="166px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:Button ID="AddEquButton" runat="server" Text="<%$Resources:Resource,btnRight %>" Font-Size="X-Small" OnClick="AddEquButton_Click" CssClass="IconRight" />
                                                <br />
                                                <br />
                                                <br />
                                                <asp:Button ID="RemoveEquButton" runat="server" Text="<%$Resources:Resource,btnLeft %>" Font-Size="X-Small" OnClick="RemoveEquButton_Click" CssClass="IconLeft" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                    <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="ddlOpType" Width="100px" runat="server">
                                                        <asp:ListItem Value="Add" Text="<%$Resources:ResourceAuth,ddlAdd %>"></asp:ListItem>
                                                        <asp:ListItem Value="Del" Text="<%$Resources:ResourceAuth,ddlReduce %>"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td></td>
                                                <td>&nbsp;</td>
                                                <td>
                                                    <asp:Button ID="btStart" runat="server" Text="<%$Resources:ResourceAuth,btnRefresh %>" OnClientClick="StartRefresh();" CssClass="IconRefresh" />                                                    
                                                    <asp:Button ID="btRemove" runat="server" Text="<%$Resources:ResourceAuth,btnClearFloor %>" OnClientClick="RemoveFloor();"  CssClass="IconDelete" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:ListBox ID="List_Msg" runat="server" Width="650px" Height="100px"></asp:ListBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                            </tr>
    ...
    <asp:HiddenField ID="hEquType" runat="server" Value="Equ" />
    ...
    <!--彈出視窗-->
    <asp:Panel ID="PanelPopup1" runat="server" SkinID="PanelPopup" Width="730px"
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <font style="color: #ffffff; font-size: 16px">※<%=this.GetLocalResourceObject("lblMustKeyin") %>※</font>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center">
                                <asp:ListBox ID="popB_CardList1" runat="server" Width="300px" Height="150px" SelectionMode="Multiple" SkinID="ListBoxSkin"></asp:ListBox>
                            </td>
                            ...
                            <td style="text-align: center">
                                <asp:ListBox ID="popB_CardList2" runat="server" Width="300px" Height="150px" SelectionMode="Multiple" SkinID="ListBoxSkin"></asp:ListBox>
                            </td>
                        </tr>
                        <tr>
