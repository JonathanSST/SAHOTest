<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="Manual.aspx.cs"
    Inherits="SahoAcs.Manual" Debug="true" EnableEventValidation="false" Theme="UI" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="position: relative; top: 10px;">
        <span style="font-size: 1cm; color: #FF0000">操作手冊清單</span><br />        
