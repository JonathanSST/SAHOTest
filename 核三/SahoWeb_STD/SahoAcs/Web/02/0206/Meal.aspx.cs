...
namespace SahoAcs
{
    public partial class Meal : System.Web.UI.Page
    {
        ...
        private static string _Equtype = "Meal";
        Hashtable TableInfo;
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("Meal", "Meal.js");//加入同一頁面所需的JavaScript檔案

            #region 註冊主頁Button動作
            QueryButton.Attributes["onClick"] = "SelectState(); return false;";
            ParaButton.Attributes["onClick"] = "CallParaSetting('" + this.GetGlobalResourceObject("Resource", "NotSelectForEdit") + "');return false;";
            AddButton.Attributes["onClick"] = "CallAdd('" + "餐勤設備資料新增" + "'); return false;";
            EditButton.Attributes["onClick"] = "CallEdit('" + "餐勤設備資料編輯" + "', '" +
                this.GetGlobalResourceObject("Resource", "NotSelectForEdit") + "'); return false;";
            DeleteButton.Attributes["onClick"] = "CallDelete('" + "餐勤設備資料刪除" + "','" +
        ...
        public void GridView_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            switch (e.Row.RowType)
            {
                ...
                case DataControlRowType.Header:
                    ...
                    #region 設定欄位寛度
                    int[] HeaderWidth = { 30, 150, 240, 100, 60 };
                ...
                case DataControlRowType.DataRow:
                    ...
                    #region 設定欄位寛度
                    int[] DataWidth = { 33, 154, 244, 104, 64 };
                    for (int i = 0; i < e.Row.Cells.Count - 1; i++)
                    ...
                    e.Row.Cells[4].Text = LimitText(e.Row.Cells[4].Text, 33, true);
                    #endregion
                    ...
                    e.Row.Attributes.Add("OnDblclick", "CallEdit('" + "餐勤設備資料編輯" + "')");
        ...
        protected void SetButton_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(SelectValue.Value))
                Sa.Web.Fun.RunJavaScript(this, "ShowErrorMsg('未選擇設備!');");
            else
            {
                SendAppCmdStrList("0" + "@" + SelectValue.Value + "@" + "SetAllCardDataStart" + "@");
                Sa.Web.Fun.RunJavaScript(this, "ShowErrorMsg('設碼動作已處理!');");
            }
        }
        #endregion
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static object Insert(string UserID, string popInput_Building, string popInput_Floor, string popInput_EquModel, string popInput_EquNo, string popInput_EquName, string popInput_EquEName, string popInput_Dci, string popInput_CardNoLen)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
            ...
            objRet = Check_Input_DB(NoArray, popInput_Building, popInput_Floor, popInput_EquModel, popInput_EquNo, popInput_EquName, popInput_EquEName, popInput_Dci, popInput_CardNoLen, "Insert");
            if (objRet.result)
            {
                #region Process String - Add EquData
                sql = @" INSERT INTO B01_EquData(EquNo, EquName, EquEName, EquClass, EquModel, CardNoLen, DciID, Building, Floor, CreateUserID, CreateTime, UpdateUserID, UpdateTime)
                         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static object Update(string UserID, string SelectValue, string popInput_Building, string popInput_Floor, string popInput_EquModel, string popInput_EquNo, string popInput_EquName, string popInput_EquEName, string popInput_Dci, string popInput_CardNoLen)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
            ...
            objRet = Check_Input_DB(NoArray, popInput_Building, popInput_Floor, popInput_EquModel, popInput_EquNo, popInput_EquName, popInput_EquEName, popInput_Dci, popInput_CardNoLen, "Update");
            if (objRet.result)
            {
        ...
        protected static Pub.MessageObject Check_Input_DB(string[] NoArray, string Building, string Floor, string EquModel, string EquNo, string EquName, string EquEName, string Dci, string CardNoLen, string mode)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
