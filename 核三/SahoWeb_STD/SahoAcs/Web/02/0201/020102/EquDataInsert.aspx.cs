...
{
    public partial class EquDataInsert : Sa.BasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            oAcsDB.GetDataTable("DropListItem", sql, out this.DataResult);
            foreach (DataRow dr in this.DataResult.Rows)
            {
                var Item = new System.Web.UI.WebControls.ListItem();
                ...
                this.EquClass.Items.Add(Item);
                this.EquClass.Attributes["onchange"] = "ChangeEquType()";
            }
