...
namespace SahoAcs
{
    public partial class DoorAccess2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //oScriptManager.RegisterAsyncPostBackControl(this.popBtn_GeneralTimeZoneIns);
            //oScriptManager.RegisterAsyncPostBackControl(this.popBtn_GeneralTimeZoneDel);
            ...
            ClientScript.RegisterClientScriptInclude("DoorAccess", "DoorAccess2.js");//加入同一頁面所需的JavaScript檔案
            ...
            AddButton.Attributes["onClick"] = "CallAdd('" + "門禁設備資料新增" + "'); return false;";
            EditButton.Attributes["onClick"] = "CallEdit('" + "門禁設備資料編輯" + "', '" +
                this.GetGlobalResourceObject("Resource", "NotSelectForEdit") + "'); return false;";
            DeleteButton.Attributes["onClick"] = "CallDelete('" + "門禁設備資料刪除" + "', '" +
                this.GetGlobalResourceObject("Resource", "NotSelectForDelete") + "'); return false;";
            Button2.Attributes["onClick"] = "CallParaSet('" + "設備參數資料設定" + "','" +
                this.GetGlobalResourceObject("Resource", "NotSelectForEdit") + "'); return false;";
            #endregion
            ...
            //popBtn_GeneralTimeZoneIns.Attributes["onClick"] = "AddRule(); return false;";
            //popBtn_GeneralTimeZoneDel.Attributes["onClick"] = "return false;";
            //popBtn_Save.Attributes["onClick"] = "return false;";
            //popBtn_Cancel.Attributes["onClick"] = "SetMode(''); CancelTrigger2.click(); return false;";
            #endregion
            ...
            else
            {
                ...
                if (sFormTarget == this.QueryButton.ClientID)
                {
                    ...
                    ViewState["query_Trt"] = this.Input_Trt.SelectedValue;
                }
                //else if (sFormTarget == this.popBtn_GeneralTimeZoneIns.ClientID)
                //{
        ...
        public void GridView_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            switch (e.Row.RowType)
            {
                ...
                case DataControlRowType.Header:
                    ...
                    #region 設定欄位寛度
                    int[] HeaderWidth = { 30, 150, 240, 60, 80, 150, 150 };
                ...
                case DataControlRowType.DataRow:
                    ...
                    #region 設定欄位寛度
                    int[] DataWidth = { 33, 154, 244, 64, 84, 154, 154 };
                    for (int i = 0; i < e.Row.Cells.Count - 1; i++)
                    ...
                    #endregion
                    #region 卡鐘設定
                    switch (oRow.Row["IsAndTrt"].ToString())
                    {
                        case "0":
                    ...
                    e.Row.Attributes.Add("OnDblclick", "CallEdit('" + "門禁設備資料編輯" + "')");
        ...
        #region popInput_InToCtrlArea_Init
        protected void popInput_InToCtrlArea_Init(object sender, EventArgs e)
        {
            System.Web.UI.WebControls.ListItem Item;
            DB_Acs oAcsDB = new DB_Acs(this.Page, Pub.GetConnectionString(Pub.sConnName));
            string sql = "";
            ...
            Item.Text = "- 請選擇 -";
            Item.Value = "";
            this.popInput_InToCtrlArea.Items.Add(Item);
            #endregion
            ...
            {
                Item = new System.Web.UI.WebControls.ListItem();
                Item.Text = dr["CtrlAreaName"].ToString();
        ...
        #region popInput_OutToCtrlArea_Init
        protected void popInput_OutToCtrlArea_Init(object sender, EventArgs e)
        {
            System.Web.UI.WebControls.ListItem Item;
            DB_Acs oAcsDB = new DB_Acs(this.Page, Pub.GetConnectionString(Pub.sConnName));
            string sql = "";
            ...
            Item.Text = "- 請選擇 -";
            Item.Value = "";
            this.popInput_OutToCtrlArea.Items.Add(Item);
            #endregion
        ...
        #region popDrop_GeneralTimeZone_Init
        protected void popDrop_GeneralTimeZone_Init(object sender, EventArgs e)
        {
            System.Web.UI.WebControls.ListItem Item;
            DB_Acs oAcsDB = new DB_Acs(this.Page, Pub.GetConnectionString(Pub.sConnName));
            string sql = "";
        ...
        public void Query(string SortExpression, string SortDire)
        {
            ...
            if (!string.IsNullOrEmpty(ViewState["query_Trt"].ToString().Trim()))
            {
                if (wheresql != "") wheresql += " AND ";
                wheresql += " (EquData.IsAndTrt = ?) ";
                liSqlPara.Add("I:" + ViewState["query_Trt"].ToString().Trim());
            }
        ...
        public static string[] LoadData(string SelectValue)
        {
            ...
            #region Process String
            sql = @" SELECT 
                     EquData.Building, EquData.Floor,
                     EquData.EquModel, EquData.EquNo, EquData.EquName, EquData.EquEName,
                     EquData.InToCtrlAreaID, EquData.OutToCtrlAreaID,
                     EquData.IsAndTrt, EquData.DciID, EquData.CardNoLen
                     FROM B01_EquData AS EquData
                     WHERE EquNo = ? ";
        ...
        #region LoadControllerData
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static string[] LoadControllerData(string SelectValue)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static string[] LoadControlData(string SelectValue)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static string[] LoadReaderData(string SelectValue)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static object Insert(string UserID, string popInput_Building, string popInput_Floor, string popInput_EquModel, string popInput_EquNo, string popInput_EquName, string popInput_EquEName, string popInput_InToCtrlArea, string popInput_OutToCtrlArea, string popInput_Trt, string popInput_Dci, string popInput_CardNoLen)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
            ...
            objRet = Check_Input_DB(NoArray, popInput_Building, popInput_Floor, popInput_EquModel, popInput_EquNo, popInput_EquName, popInput_EquEName, popInput_InToCtrlArea, popInput_OutToCtrlArea, popInput_Dci, popInput_CardNoLen, "Insert");
            if (objRet.result)
            {
                #region Process String - Add EquData
                sql = @" INSERT INTO B01_EquData(EquNo, EquName, EquEName, EquClass, EquModel, CardNoLen, IsAndTrt, DciID, Building, Floor, InToCtrlAreaID, OutToCtrlAreaID, CreateUserID, CreateTime, UpdateUserID, UpdateTime)
                         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
                ...
                liSqlPara.Add("I:" + popInput_Trt.Trim());
                liSqlPara.Add("I:" + popInput_Dci.Trim());
                liSqlPara.Add("S:" + popInput_Building.Trim());
                liSqlPara.Add("S:" + popInput_Floor.Trim());
                liSqlPara.Add("I:" + popInput_InToCtrlArea.Trim());
                liSqlPara.Add("I:" + popInput_OutToCtrlArea.Trim());
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static object Update(string UserID, string SelectValue, string popInput_Building, string popInput_Floor, string popInput_EquModel, string popInput_EquNo, string popInput_EquName, string popInput_EquEName, string popInput_InToCtrlArea, string popInput_OutToCtrlArea, string popInput_Trt, string popInput_Dci, string popInput_CardNoLen)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
            ...
            objRet = Check_Input_DB(NoArray, popInput_Building, popInput_Floor, popInput_EquModel, popInput_EquNo, popInput_EquName, popInput_EquEName, popInput_InToCtrlArea, popInput_OutToCtrlArea, popInput_Dci, popInput_CardNoLen, "Update");
            if (objRet.result)
            {
                #region Process String - Updata EquData
                sql = @" UPDATE B01_EquData
                         SET EquNo = ?, EquName = ?, EquEName = ?,
                         EquModel = ?, CardNoLen = ?, IsAndTrt = ?,
                         DciID = ?,
                         Building = ?, Floor = ?,
                         InToCtrlAreaID = ?, OutToCtrlAreaID = ?,
        ...
        protected static Pub.MessageObject Check_Input_DB(string[] NoArray, string Building, string Floor, string EquModel, string EquNo, string EquName, string EquEName, string InToCtrlArea, string OutToCtrlArea, string Dci, string CardNoLen, string mode)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
            ...
            if (string.IsNullOrEmpty(Floor.Trim()))
            {
                if (!string.IsNullOrEmpty(objRet.message)) objRet.message += "\n";
                objRet.result = false;
                objRet.message += "樓層 必須輸入";
            }
            else if (Floor.Trim().Count() > 10)
            {
                if (!string.IsNullOrEmpty(objRet.message)) objRet.message += "\n";
                objRet.result = false;
                objRet.message += "樓層 字數超過上限";
            }
            ...
            //if (string.IsNullOrEmpty(InToCtrlArea.Trim()))
            //{
            //    if (!string.IsNullOrEmpty(objRet.message)) objRet.message += "\n";
            //    objRet.result = false;
            //    objRet.message += "進入管制區 必須指定";
            //}

            //if (string.IsNullOrEmpty(OutToCtrlArea.Trim()))
            //{
            //    if (!string.IsNullOrEmpty(objRet.message)) objRet.message += "\n";
            //    objRet.result = false;
            //    objRet.message += "離開管制區 必須指定";
            //}
