...
namespace SahoAcs
{
    public partial class TRT2 : System.Web.UI.Page
    {
        #region Main Description
        AjaxControlToolkit.ToolkitScriptManager oScriptManager;
        private int _pagesize = 20;
        private static string _Equtype = "TRT";
        Hashtable TableInfo;
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("TRT", "TRT2.js");//加入同一頁面所需的JavaScript檔案
            ...
            AddButton.Attributes["onClick"] = "CallAdd('" + "考勤設備資料新增" + "'); return false;";
            EditButton.Attributes["onClick"] = "CallEdit('" + "考勤設備資料編輯" + "', '" +
                this.GetGlobalResourceObject("Resource", "NotSelectForEdit") + "'); return false;";
            DeleteButton.Attributes["onClick"] = "CallDelete('" + "考勤設備資料刪除" + "', '" +
        ...
        public void GridView_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            switch (e.Row.RowType)
            {
                ...
                case DataControlRowType.Header:
                    ...
                    #region 設定欄位寛度
                    int[] HeaderWidth = { 60, 150, 240, 100, 60 };
                ...
                case DataControlRowType.DataRow:
                    ...
                    #region 設定欄位寛度
                    int[] DataWidth = { 63, 154, 244, 104, 64 };
                    for (int i = 0; i < e.Row.Cells.Count - 1; i++)
                    ...
                    e.Row.Attributes.Add("OnDblclick", "CallEdit('" + "考勤設備資料編輯" + "')");
        ...
        public static string[] LoadData(string SelectValue)
        {
            ...
            sql = @" SELECT 
                     ...
                     EquData.DciID, EquData.CardNoLen,EquData.IsShowName
                     FROM B01_EquData AS EquData
                     WHERE EquNo = ? ";
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static object Insert(string UserID, string popInput_Building, string popInput_Floor, string popInput_EquModel, string popInput_EquNo,
            string popInput_EquName, string popInput_EquEName, string popInput_Dci, string popInput_CardNoLen, string IsShowName)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            string sql = "";
            ...
            if (objRet.result)
            {
                ...
                sql = @" INSERT INTO B01_EquData(EquNo, EquName, EquEName, EquClass, EquModel, CardNoLen, DciID, Building, Floor, CreateUserID, CreateTime, UpdateUserID, UpdateTime,IsShowName)
                         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
        ...
        [System.Web.Services.WebMethod()]
        [System.Web.Script.Services.ScriptMethod()]
        public static object Update(string UserID, string SelectValue, string popInput_Building, string popInput_Floor, string popInput_EquModel, string popInput_EquNo,
            string popInput_EquName, string popInput_EquEName, string popInput_Dci, string popInput_CardNoLen, string IsShowName)
        {
            DB_Acs oAcsDB = new DB_Acs(Pub.GetConnectionString(Pub.sConnName));
            Pub.MessageObject objRet = new Pub.MessageObject();
            ...
            if (objRet.result)
            {
                ...
                sql = @" UPDATE B01_EquData
                         ...
                         Building = ?, Floor = ?,
                         UpdateUserID = ?, UpdateTime = ?, IsShowName=? 
                         WHERE EquNo = ? ";
