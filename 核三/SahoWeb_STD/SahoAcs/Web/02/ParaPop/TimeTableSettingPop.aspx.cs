...
namespace SahoAcs
{
    public partial class TimeTableSettingPop : Sa.BasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("TimeTableSetting", "/Web/02/ParaPop/TimeTableSettingPop.js");//加入同一頁面所需的JavaScript檔案
