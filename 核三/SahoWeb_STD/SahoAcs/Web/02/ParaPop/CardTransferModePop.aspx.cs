...
namespace SahoAcs
{
    public partial class CardTransferModePop : Sa.BasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("CardTransferMode", "CardTransferModePop.js");//加入同一頁面所需的JavaScript檔案
