...
namespace SahoAcs
{
    public partial class LightInfoSettingPop : Sa.BasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("LightInfoSetting", "/Web/02/ParaPop/LightInfoSettingPop.js");//加入同一頁面所需的JavaScript檔案
