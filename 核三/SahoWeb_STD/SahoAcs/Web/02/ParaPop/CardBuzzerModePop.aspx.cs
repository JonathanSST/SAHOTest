...
namespace SahoAcs
{
    public partial class CardBuzzerModePop : Sa.BasePage
    {
        ...
        protected void Page_InitComplete(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("CardBuzzerMode", "/Web/02/ParaPop/CardBuzzerModePop.js");//加入同一頁面所需的JavaScript檔案            
        ...
        public void LoadData()
        {
            ...
            string EquID = Request["EquID"];
            string EquModel = "";
            foreach(var o in this.odo.GetQueryResult("SELECT * FROM B01_EquData WHERE EquID=@EquID",new {EquID=Request["EquID"]}))
            {
                EquModel = Convert.ToString(o.EquModel);
                if (EquModel.Contains("SCM320"))
                {
                    this.popInput_Buzzer1.Attributes.Add("value", "01");
                }
            }
