<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryPsnEquGroup.aspx.cs" 
    Inherits="SahoAcs.QueryPsnEquGroup" EnableEventValidation="false" Theme="UI" %>
                        ...
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight">
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" PageSize="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EquGrpList" HeaderText="設備群組清單" />
                                </Columns>
                                <PagerTemplate>
