<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PsnCardNoneRecord.aspx.cs" Inherits="SahoAcs.Web._0676.PsnCardNoneRecord" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table>
                    <tr>
                        <th class="ShowPsnInfo">
                            ...
                            <asp:Label ID="Label1" runat="server" Text="查核設備"></asp:Label>
                        </th>
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_Dept" runat="server" Text="未打卡天數"></asp:Label>
                        </th>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>                         
                        <td class="ShowPsnInfo">
                            <select id="EquNoName" name="EquNoName" style="width:200px" class="DropDownListStyle">
                                <%foreach (var o in this.EquList)
                                    { %>
                                <option value="<%=o.EquNo %>"><%=o.EquName+" ("+o.EquNo+")" %></option>
                                <%} %>
                            </select>
                        </td>
                        <td class="ShowPsnInfo">                            
                            <select id="ddlRangeDay" name="ddlRangeDay" style="width:100px" class="DropDownListStyle">
                                <%for (int i = 1; i < 31; i++)
                                    { %>
                                    <option value="<%=i %>"><%=string.Format("{0}日", i) %></option>
                                <%} %>
                            </select>
                        </td>                                                                     
                        <td>
    ...
    <div id="ContentPlaceHolder1_UpdatePanel1">
        <table class="TableS1" style="width:870px">
            <tbody>
                <tr class="GVStyle">
...
<%--                    <th scope="col" style="width:120px;"><%=GetLocalResourceObject("ttCardTime") %></th>
                ...
                <tr>
                    <td id="ContentPlaceHolder1_td_showGridView" colspan="11">
                        <div id="ContentPlaceHolder1_tablePanel" class="MinHeight" style="width: 870px; overflow-y: scroll;">
                            <div>
