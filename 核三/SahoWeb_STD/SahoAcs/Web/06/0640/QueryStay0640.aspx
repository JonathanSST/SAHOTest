<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStay0640.aspx.cs" Inherits="SahoAcs.QueryStay0640" %>
            ...
            <tbody>
                ...
                <tr>
                    <td id="ContentPlaceHolder1_td_showGridView" colspan="11">
                        <div id="ContentPlaceHolder1_tablePanel" class="MinHeight" style="width: 450px; overflow-y: scroll;">
                            <div>
                ...
                <tr class="GVStyle">
                    ...
                    <td scope="col" class="TitleRow" style="width:120px">
                         <%=this.ListLogOut.Sum(i=>i.TotalIn) %>
                    </td>
                    <td scope="col" class="TitleRow">
                         <%=this.ListLogOut.Sum(i=>i.TotalOut) %>
                    </td>
                </tr>
            </tbody>
        </table>
