...
namespace SahoAcs.Web._0625
{
    ...
    /// MapStory 的摘要描述
    /// </summary>
    public class MapStory : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            this.logs = this.odo.GetQueryResult<CardLogMap>(@"SELECT 
                                                ...
                                                FROM 
	                                                ...
	                                                INNER JOIN B03_MapPoint C ON B.EquID=C.EquID WHERE CardNo=@CardNo AND CardTime BETWEEN @DateS AND @DateE ORDER BY CardTime ",
                                                new {CardNo= context.Request["CardNo"], DateS=context.Request["DateS"],DateE=context.Request["DateE"]}).ToList();
