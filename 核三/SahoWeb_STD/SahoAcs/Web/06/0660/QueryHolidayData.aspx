<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryHolidayData.aspx.cs" Inherits="SahoAcs.Web._06._0660.QueryHolidayData" %>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <th>
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_PsnName" runat="server" Text="人員編號"></asp:Label>
                        </th>
                        <td></td>
                    </tr>
                    <tr>
