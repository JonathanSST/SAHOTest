...
namespace SahoAcs
{
    public partial class QueryWorkDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("jsfun", "QueryWorkDetail.js?" + DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
        }
            ...
            if (this.ListLog.Count > 0)
            {
                ...
                foreach (var p in PsnNoList)
                {
                    ...
                    foreach (var o in this.ListLog.Where(i => i.PsnNo.Equals(p)))
                    {
                        ...
                        sb.Append(string.Format("<td class='DataBar' style='vertical-align:top'>{0}</td></tr>", string.Join("<br/>",o.StatuDesc.Split(','))));
