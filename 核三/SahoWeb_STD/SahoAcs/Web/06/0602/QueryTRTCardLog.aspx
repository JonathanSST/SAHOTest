<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryTRTCardLog.aspx.cs" Inherits="SahoAcs.QueryTRTCardLog" %>
            ...
            <tr>
                <td>
                    <table>
                        ...
                        <tr>
                            <th>
                                <span id="TempVal"><%=this.GetLocalResourceObject("ttTemperature") %></span>
                            </th>
                            <th></th>
                        </tr>
                        <tr>
