...
namespace SahoAcs.Web._06._0602
{
    public partial class _0602Rpt : System.Web.UI.Page
    {
        ...
        {            
            ...
            string sqlorgjoin = @"SELECT 
	                                        B01_OrgStruc.OrgStrucID,OrgStrucNo,OrgIDList
                                        FROM 
	                                        B01_OrgStruc                
            ...
            sql = @"SELECT A.*,IDNum FROM B01_CardLog A INNER JOIN B01_Person B ON A.PsnNo=B.PsnNo WHERE 1=1 ";
