...
namespace SahoAcs
{
    public partial class QueryTRTCardLog : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("0602", "QueryTRTCardLog.js?"+Pub.GetNowTime);//加入同一頁面所需的JavaScript檔案
        }
        ...
        private void SetQueryData()
        {
            ...
            sql = @" SELECT * FROM V_CardLogOrg	                    
                        WHERE (EquNo IN @EquList) AND (EquClass='TRT' OR IsAndTrt=1) ";
