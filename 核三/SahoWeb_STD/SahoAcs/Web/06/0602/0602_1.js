...
function SetPrint() {
    ...
    //$("#CardTimeS").val($('[name*="Calendar_CardTimeSDate"]').val());
    //$("#form1").submit();    
    window.open("0602Rpt.aspx?EquClass="+$('[name*="EquClass"]:checked').val()+"&CardTimeS=" + $('[name*="Calendar_CardTimeSDate"]').val() + "&CardTimeE=" + $('[name*="Calendar_CardTimeEDate"]').val() + "&CardNoPsnNo=" + $("#CardNoPsnNo").val());
    //$("#PageEvent").val("Print");
