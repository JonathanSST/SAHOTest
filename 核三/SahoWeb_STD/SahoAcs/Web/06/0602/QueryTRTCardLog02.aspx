<%@ Page Language="C#" Inherits="SahoAcs.QueryTRTCardLog" MasterPageFile="~/Site1.Master" Debug="true" AutoEventWireup="true" EnableEventValidation="false" Theme="UI" CodeBehind="QueryTRTCardLog.aspx.cs" %>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td runat="server" id="ShowPsnInfo2">
                            <asp:TextBox ID="TextBox_CardNo_PsnName" runat="server" Width="200px"></asp:TextBox></td>
                        <td>
            ...
            <table cellspacing="0" class="TableS1">
                ...
                <tr>
                    <td id="td_showGridView" runat="server">
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight" Width="1700px">
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" PageSize="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CtrlNo" HeaderText="<%$Resources:ttCtrlNo %>" SortExpression="CtrlNo" />
                                    <asp:BoundField DataField="ReaderNo" HeaderText="<%$Resources:ttReaderNo %>" SortExpression="ReaderNo" />
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="ADVTextBox_PsnNo" runat="server" Width="120"></asp:TextBox></td>
                                        <td>
