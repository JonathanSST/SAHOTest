<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Theme="UI"
    CodeBehind="QueryInOutList.aspx.cs" Inherits="SahoAcs.Web.QueryInOutList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="TableS1" style="width: 1100px">
        <tbody>
            <tr class="GVStyle">
                <th scope="col" style="width: 125px;">讀卡時間</th>                
                ...
                <th scope="col" style="width: 110px;">設備編號</th>
                        ...
                        <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                            <tbody>
                                ...
                                <tr id="GV_Row1" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)">
                                    <td style="width: 129px"><%=string.Format("{0:yyyy/MM/dd HH:mm:ss}",o.CardTime) %></td>                                    
                                    ...
                                    <td style="width: 114px"><%=o.EquNo %></td>
