<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryModify0643.aspx.cs" Inherits="SahoAcs.QueryModify0643" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table>
                     <tr>
                        <th colspan="3">
                            ...
                            <asp:Label ID="QueryLabel_CardDate" runat="server" Text="異動日期起迄"></asp:Label>
                        </th>                                                                        
                        <td></td>
                    </tr>
                    <tr>
    ...
    <div id="ContentPlaceHolder1_UpdatePanel1">
        <table class="TableS1" style="width:750px">
            <tbody>
                <tr class="GVStyle">
                ...
                <tr>
                    <td id="ContentPlaceHolder1_td_showGridView" colspan="11">
                        <div id="ContentPlaceHolder1_tablePanel" class="MinHeight" style="width: 750px; overflow-y: scroll;">
                            <div>
