<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryAlarmMap.aspx.cs" Inherits="SahoAcs.QueryAlarmMap" EnableEventValidation="false" Theme="UI" %>
                        ...
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight" Width="1225px">
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" PageSize="5"
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="<%$Resources:ttCardNo %>" SortExpression="CardNo">
                                        <ItemTemplate>                                            
                                            <asp:LinkButton ID="BtnMap" runat="server" EnableViewState="false" CssClass="ShowMap">
