...
namespace SahoAcs
{
    public partial class QueryEATCardLog : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("QueryEATCardLog", "QueryEATCardLog.js");//加入同一頁面所需的JavaScript檔案
            ...
            if (!IsPostBack && !oScriptManager.IsInAsyncPostBack)
            {
                ...
                Query("Normal", false, ViewState["SortExpression"].ToString(), ViewState["SortDire"].ToString());
            }
            else
            {
        ...
        public void GridView_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            switch (e.Row.RowType)
            {
                ...
                case DataControlRowType.Header:
                    ...
                    #region 設定欄位寛度
                    int[] HeaderWidth = { 150, 100, 120, 120, 80, 120, 40, 100, 100, 100, 150, 100, 150 };
                ...
                case DataControlRowType.DataRow:
                    ...
                    #region 設定欄位寛度
                    int[] DataWidth = { 153, 104, 124, 124, 84, 124, 44, 104, 104, 104, 154, 104, 154 };
                    for (int i = 0; i < e.Row.Cells.Count - 1; i++)
        ...
        {
            String SortField = e.SortExpression, SortDire = "";
        ...
        public void Query(string sMode, bool bMode, string SortExpression, string SortDire)
        {
            ...
            string strUnionTB = Pub.ReturnNewNestedSerachSQL("0604", 
                ViewState["query_CardTimeSDate"].ToString(),
                ViewState["query_CardTimeEDate"].ToString());
            ...
            sql = @" SELECT ROW_NUMBER() OVER(ORDER BY " + SortExpression + " " + SortDire + @") AS NewIDNum,
                B01_CardLog.RecordID, B01_CardLog.CardTime, B01_CardLog.DepID,
            ...
            //wheresql = " ( ( B01_CardLog.CardType = 'E' OR B01_CardLog.CardType = 'T') AND ( B01_CardLog.EquClass = 'Meal' ) ) ";

            // 20170327 拿掉CardType的判斷
            wheresql = " ( B01_CardLog.EquClass = 'Meal' ) ";
            ...
            if (bMode == true)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "alert", "alert('無資料可匯出!!');location.href='QueryEATCardLog.aspx';", true);
                }
            }
            else
            {
        ...
        public static string[] LoadData(string SelectValue)
        {
            ...
            string strUnionTB = Pub.ReturnNewNestedSerachSQL("0604_LoadData", "","");
            ...
            sql = @" SELECT 
                     ...
                     B01_CardLog.LogTime
                     FROM " + strUnionTB + " AS B01_CardLog " +
                     @"INNER JOIN dbo.B01_Card AS Card ON Card.CardNo = B01_CardLog.CardNo AND (Card.CardVer = B01_CardLog.CardVer OR (Card.CardVer IS NULL AND CardLog.CardVer IS NULL ))
        ...
        private void CreateDropDownList_EquItem()
        {
            ...
            #region DataAuth
            if (wheresql != "") wheresql += " AND ";
            wheresql += " (SysUserMgns.UserID = ? ) AND (EquData.EquClass = 'EAT') ";
            liSqlPara.Add("S:" + this.hideUserID.Value);
            #endregion
        ...
        public void ExportExcel(DataTable ProcDt)
        {
            ...
            ws.Cells[1, 2].Value = "部門代碼";
            ws.Cells[1, 3].Value = "部門名稱";
