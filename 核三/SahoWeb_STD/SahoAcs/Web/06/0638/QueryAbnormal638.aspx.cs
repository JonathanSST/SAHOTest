...
namespace SahoAcs
{
    public partial class QueryAbnormal638 : System.Web.UI.Page
    {
        ...
        {            
            ...
            ClientScript.RegisterClientScriptInclude("0638", "QueryAbnormal638.js?"+DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
        }
            ...
            foreach (var o in this.ListLog)
            {
                    ...
                    && i.PsnNo == o.IDNO).OrderBy(i => i.CardTime))
                {
                    if (log.EquDir == "進")
                    {
                        ...
                        TempData.Add(newlog);       //先加入CardLog為進的紀錄
                    }
                }//完成CardLog二道門進的設定
                    ...
                    && i.PsnNo == o.IDNO).OrderBy(i => i.CardTime))
                {
                    if (log.EquDir == "出")
                    {
                        ...
                        else
                        {
                            ...
                            TempData.Add(newlog);   //若前筆記錄不為進，則加到異常紀錄
                        }
                    }
                }//完成CardLog二道門出的設定
            }//完成原始紀錄的搜尋
        ...
        private void ExportExcel()
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=QueryAbnormal.xlsx");
