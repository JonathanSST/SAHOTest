<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStay0639.aspx.cs" Inherits="SahoAcs.QueryStay0639" %>
    ...
    <div id="ContentPlaceHolder1_UpdatePanel1">
        <table class="TableS1" style="width:970px">
            <tbody>
                ...
                <tr class="GVStylePgr">
                    <td colspan="11">
                        <%=string.Format("未出人數:{0} 未進人數:{1}",this.ListLog.Where(i=>i.EquDir=="進").Count(),this.ListLog.Where(i=>i.EquDir=="出").Count()) %>
                    </td>
                </tr>
            </tbody>
        </table>
