...
namespace SahoAcs
{
    public partial class QueryStay0641 : System.Web.UI.Page
    {
        ...
        {            
            ...
            ClientScript.RegisterClientScriptInclude("0641", "QueryStay0641.js?"+DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
        }
				 ...
				 FROM B01_CardLog A 
                    ...
                    GROUP BY
	                    CardNo) B2 ON A.CardNo=B2.CardNo AND A.CardTime=B2.CardTime
	                     ...
	                     LEFT JOIN OrgStrucAllData('Department') C ON B.OrgStrucID=C.OrgStrucID WHERE EquDir='進' ";
