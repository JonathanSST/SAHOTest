...
namespace SahoAcs
{
    public partial class QueryOutTime0641 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("0641", "QueryOutTime0641.js?" + DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
        }
        ...
        private void SetQueryData()
        {
            ...
            string sql = "";
            sql = @"SELECT * FROM B00_OracleRecord WHERE (InTime2nd BETWEEN @CardDateS AND @CardDateE)  AND OPLTTM='*'  ";
            ...
            foreach (var o in this.ListLog)
            {
                ...
                if (newlog.OutId == 0 || newlog.OutTime2nd<newlog.InTime2nd)
                {                    
                    var TsAll = DateTime.Now - newlog.InTime2nd.Value;
                    if (TsAll.TotalMinutes > 60)
                    {
                        TempData.Add(newlog);
                    }
                }
                ...
                {
                    if (newlog.OutTime2nd < newlog.InTime2nd)
                    {
                        TimeSpan ts1 = new TimeSpan(DateTime.Now.Ticks);
                        TimeSpan ts0 = new TimeSpan(newlog.InTime2nd.Value.Ticks);
                        var TsAll = DateTime.Now - newlog.InTime2nd.Value;                        
                    }
                }
            }
        ...
        private void ExportExcel()
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=QueryOutTime.xlsx");
