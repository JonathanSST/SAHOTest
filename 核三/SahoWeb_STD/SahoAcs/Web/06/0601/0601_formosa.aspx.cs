...
namespace SahoAcs
{
    public partial class _0601_formosa : System.Web.UI.Page
    {
        ...
        public string SortName = "DepName";
        ...
        {            
            ...
            ClientScript.RegisterClientScriptInclude("0601", "0601_formosa.js?"+DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
        }
        ...
        private void SetQueryData()
        {
            ...
            this.ListLog = this.odo.GetQueryResult<CardLogModel>(sql, new
            {
                ...
                PsnID = Request["PsnID"]
            }).OrderBy(o => o.CardTime).OrderByField("PsnNo",SortType=="ASC").OrderByField(SortName,SortType=="ASC").ToList();
