...
namespace SahoAcs
{
    public partial class _0601_tc : System.Web.UI.Page
    {
        ...
        {            
            ...
            ClientScript.RegisterClientScriptInclude("0601", "0601_tc.js?"+DateTime.Now.ToString("yyyyMMddHHmmss"));//加入同一頁面所需的JavaScript檔案
        }
        ...
        private void SetInitData()
        {
            ...
            this.ListCols.Add(new ColNameObj() { ColName = "LogTimeVal", DataRealName = "LogTime", DataWidth = 123, TitleWidth = 120, TitleName = GetLocalResourceObject("ttLogTime").ToString() });            
        ...
        private void SetQueryData()
        {
            ...
            sql = @" SELECT C.*,P.IDNum FROM B01_CardLog C INNER JOIN B01_Person P ON C.PsnNo=P.PsnNo WHERE (EquNo IN @EquList)";
            ...
            this.ListLog = this.odo.GetQueryResult<CardLogModel>(sql, new
            {
                ...
                PsnID = Request["PsnID"]
            }).OrderBy(o => o.CardTime).OrderBy(o => o.PsnNo).OrderBy(o => o.DepName).ToList();
        ...
        private string GetConditionCmdStr()
        {
            ...
            {
                sql += " AND (P.PsnNo LIKE @PsnName OR P.PsnName LIKE @PsnName OR CardNo LIKE @PsnName OR IDNum LIKE @PsnName) ";
            }
