<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryOpenDoorZZ.aspx.cs" Inherits="SahoAcs.QueryOpenDoorZZ" %>
    ...
    <div id="ContentPlaceHolder1_UpdatePanel1">
        <table class="TableS1" style="width:950px">
            <tbody>
                ...
                <tr class="GVStyle">
                     <td colspan="11">
                         <%=string.Format("總筆數：{0}",this.DataResult.Rows.Count) %>
                    </td>                    
                </tr>
            </tbody>
        </table>
