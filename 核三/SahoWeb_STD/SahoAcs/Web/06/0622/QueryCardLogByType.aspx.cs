...
namespace SahoAcs
{
    public partial class QueryCardLogByType : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterClientScriptInclude("QueryCardLog", "QueryCardLogByType.js");//加入同一頁面所需的JavaScript檔案
        ...
        public void GridView_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            switch (e.Row.RowType)
            {
                ...
                case DataControlRowType.Header:
                    ...
                    #region 設定欄位寛度
                    int[] HeaderWidth = { 150, 120, 120, 80, 120, 40, 100, 100, 100, 150, 80, 150 };
                ...
                case DataControlRowType.DataRow:
                    ...
                    #region 設定欄位寛度
                    int[] DataWidth = { 153, 124, 124, 84, 124, 44, 104, 104, 104, 154, 84, 154 };
                    for (int i = 0; i < e.Row.Cells.Count - 1; i++)
                ...
                case DataControlRowType.Pager:
                    ...
                    int pageCount = this.cardlogs.ToPagedList(1, _pagesize).PageCount;
        ...
        public void Query(string sMode, bool bMode, string SortExpression, string SortDire)
        {
            ...
            var EquDatas = this.odo.GetQueryResult<EquGroupData>(@"SELECT B01_EquData.EquNo, B01_EquData.EquName FROM B01_EquData
                ...
                WHERE B00_SysUserMgns.UserID = @UserID GROUP BY B01_EquData.EquNo, B01_EquData.EquName", new { UserID = this.hideUserID.Value });
            ...
            if (sMode == "Normal")
            {
                ...
                this.cardlogs = this.odo.GetQueryResult<CardLogModel>(sql, new
                {
                    ...
                    PsnName = "%" + ViewState["query_CardNo_PsnName"].ToString().Trim() + "%",
            ...
            if (bMode == true)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "alert", "alert('無資料可匯出!!');location.href='QueryCardLogByType.aspx';", true);
                }
            }
            else
            {
        ...
        public void ExportExcel(DataTable ProcDt)
        {
            ...
            string[] colnamelist = { "CardTime", "DepName", "PsnNo", "PsnName", "CardNo", "CardVer", "CtrlNo", "ReaderNo", "EquNo", "EquName", "LogStatus", "LogTime" };
            //Title
