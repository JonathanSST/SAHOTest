<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="0622.aspx.cs" Inherits="SahoAcs._0622" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="ValueKeep">
        ...
        <input type="hidden" id="EquClass" name="EquClass" value="" />
    </div>
    <table class="Item">
        <tr>
            <td>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select style="width:99%" id="ddlEquClass" name="ddlEquClass" class="DropDownListStyle">
                                <option value="D">門禁</option>
                                <option value="A">考勤</option>
                                <option value="B">崗哨</option>
                                <option value="C">教育訓練</option>
                            </select>
                        </td>                      
                        <td class="ShowPsnInfo">
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <select style="width: 99%" id="advEquClass" name="advEquClass" class="DropDownListStyle">
                                                <option value="D">門禁</option>
                                                <option value="A">考勤</option>
                                                <option value="B">崗哨</option>
                                                <option value="C">教育訓練</option>
