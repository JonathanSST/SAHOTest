<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GroupClassDefine.aspx.cs" Inherits="SahoAcs.Web._01._0119.GroupClassDefine" Theme="UI" %>
        ...
        <tr>
            <td style="height: 250px; width: 820px; vertical-align: top" id="EquArea">
                ...
                <table class="TableS1">
                    <tbody>
                        <tr class="GVStyle">
                            <th scope="col" style="width: 105px">組別編號</th>
                            <th scope="col" style="width: 105px">組別名稱</th>
                            <th scope="col" style="width: 155px">末二日班別(<%=Date2 %>日)</th>
                            <th scope="col">末一日班別(<%=Date1 %>日)</th>
                        </tr>
                        <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 109px">
                                                        <%=work.GroupNo %>
                                                        <input type="hidden" id="GroupNo" name="GroupNo" value="<%=work.GroupNo %>" />
                                                        <input type="hidden" id="GroupName" name="GroupName" value="<%=work.GroupName %>" />
                                                    </td>
                                                    <td style="width: 109px">
                                                        <%=work.GroupName %>
                                                    </td>
