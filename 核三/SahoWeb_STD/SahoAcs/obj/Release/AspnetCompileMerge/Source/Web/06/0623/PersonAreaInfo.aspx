<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PersonAreaInfo.aspx.cs" Inherits="SahoAcs.Web._0623.PersonAreaInfo" %>
            ...
            <td>
                <table>
                    <tr>                        
                        ...
                        <th class="ShowPsnInfo" style="width:155px">
                            <span class="Arrow01"></span>
                            <asp:Label ID="Label1" runat="server" Text="最後刷卡區間(日)"></asp:Label>
                        </th>
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="Label2" runat="server" Text="管制區"></asp:Label>
                        </th>
                    ...
                    <tr>                        
                        ...
                        <td  class="ShowPsnInfo">                            
                            <select id="RangeDay" name="RangeDay" style="width:100px" class="DropDownListStyle">
                                <%for (int i = 1; i < 31; i++)
                                    { %>
                         ...
                         <td  class="ShowPsnInfo">                            
                            <select id="CtrlArea" name="CtrlArea" style="width:200px" class="DropDownListStyle">
                                <option value="">請選擇</option>
                                <%foreach (var o in this.ListArea)
                                    { %>
                                <option value="<%=o.CtrlAreaNo %>"><%=string.Format("{0} ({1})",  o.CtrlAreaNo, o.CtrlAreaName) %></option>
                                <%} %>
                            </select>
                        </td>
                        <td class="ShowPsnInfo">                            
