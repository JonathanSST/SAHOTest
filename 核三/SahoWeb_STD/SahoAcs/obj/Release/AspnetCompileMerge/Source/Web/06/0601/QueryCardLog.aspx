<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryCardLog.aspx.cs" Inherits="SahoAcs.QueryCardLog" %>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <th>
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLable_Company" runat="server" Text="單位"></asp:Label>
                        </th>
                    ...
                    <tr>
                        ...
                        <td class="ShowPsnInfo">
                            <input type="text" id="CardNoPsnNo" name="CardNoPsnNo" style="width: 180px" value="<%=this.txt_CardNo_PsnName %>" />
                        </td>
                        <td style="width:160px;">
                            <uc2:MultiSelectDropDown runat="server" ID="DropDownList_LogStatus" ListWidth="150" ListHeight="300" />
                        </td>
                        <td style="width:210px;">
                            <uc2:MultiSelectDropDown runat="server" ID="DropDownList_Company" ListWidth="200" ListHeight="300" />
                        </td>
                        <td class="ShowPsnInfo">
                                ...
                                <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        ...
                                        <%foreach (System.Data.DataRow r in this.DataResult.Rows)
                                            { %>
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" ondblclick="SetShowOneLog(<%=r["RecordID"].ToString() %>)" style="color: rgb(0, 0, 0);">
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADVQueryLabel_Dep" runat="server" Text="單位"></asp:Label>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>
            ...
            <tr>
                <td>
                    <table>
                        ...
                        <tr>
                            <th>
                                <span id="CamNo">CamNo</span>
                            </th>
                            <td id="CameraArea"></td>
                        </tr>
                        <tr>
                            <th>
                                <span id="TempVal">體溫量測值：</span>
                            </th>
                            <th></th>
                        </tr>
                        <tr>
                            <th><span id="HeatResult"></span></th>
                            <td></td>
                        </tr>
                    </table>
                    <table>
