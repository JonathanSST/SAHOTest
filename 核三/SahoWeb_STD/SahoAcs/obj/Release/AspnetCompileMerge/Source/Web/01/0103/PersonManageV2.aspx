<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Theme="UI" CodeBehind="PersonManageV2.aspx.cs" Inherits="SahoAcs.Web.PersonManageV2" %>
            ...
            <td>
                ...
                <select style="width: 200px" class="DropDownListStyle" id="CompanyList">
                    ...
                    <%foreach (var o in this.OrgDataInit.Where(i => i.OrgClass == "Company"))
                        { %>
                    <option value="<%=o.OrgNo %>"><%=o.OrgName+"."+o.OrgNo%></option>
                    <%} %>
                </select>
            </td>
            <td>
                        ...
                        <table class="Item">
                            <tr>
                                <td style="vertical-align: top; width: 250px;">
                                    ...
                                    <div>
                                        <select style="width: 200px" class="DropDownListStyle" id="PsnType" name="PsnType">
                                            <%foreach (var o in this.PsnTypeList)
                                                { %>
                                            <%if (this.PersonObj.PsnType == Convert.ToString(o.ItemNo))
                                                { %>
                                            <option selected="selected" value="<%=Convert.ToString(o.ItemNo) %>"><%=string.Format("{0}.{1}", o.ItemName, o.ItemNo)%></option>
                                            <%}
                                            else
                                            { %>
                                            <option value="<%=Convert.ToString(o.ItemNo) %>"><%=string.Format("{0}.{1}", o.ItemName, o.ItemNo)%></option>
                                ...
                                <div>                                    
                                    ...
                                    <%} %>
                                    <div>
                                        <span id="lblPsnAuthAllow">權限狀態：</span>
                                    </div>
                                    <div>
                                        <select name="PsnAuthAllow" id="PsnAuthAllow" class="DropDownListStyle" style="width: 180px;">
                                            <%if (this.PersonObj.PsnAuthAllow == "0")
                                                {%>
                                                    <option selected="selected" value="0">離職(校)/停用</option>
                                                <%}
                                                else
                                                { %>
                                                    <option value="0">離職(校)/停用</option>
                                            <%} %>
                                            <%if (this.PersonObj.PsnAuthAllow == "1")
                                                {%>
                                                    <option selected="selected" value="1">在職(校)/啟用</option>
                                                <%}
                                                else
                                                { %>
                                                    <option value="1">在職(校)/啟用</option>
                                            <%} %>
                                        </select>
                                    </div>
                                    <div>
