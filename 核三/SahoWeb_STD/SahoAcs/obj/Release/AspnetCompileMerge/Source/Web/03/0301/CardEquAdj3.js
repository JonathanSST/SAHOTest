...
function CallTable(type) {
    switch (type) {
        case "Card":
            ChangeText(L_popName1, '卡片資料選取');
            ChangeText(popLabel_OrgList, '卡片列表');
            break;
        case "Org":
            ChangeText(L_popName1, '組織資料選取');
            ChangeText(popLabel_OrgList, '組織列表');
            break;
        case "No":
            ChangeText(L_popName1, '工號資料選取');
            ChangeText(popLabel_OrgList, '工號列表');
            break;
        case "Name":
            ChangeText(L_popName1, '姓名資料選取');
            ChangeText(popLabel_OrgList, '姓名列表');
            break;
        default:
            break;
    }
