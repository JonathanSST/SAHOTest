<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PsnCardDblRecord.aspx.cs" Inherits="SahoAcs.Web._0677.PsnCardDblRecord" %>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <th class="ShowPsnInfo" colspan="3">
                            <span class="Arrow01"></span>
                            <asp:Label ID="Label2" runat="server" Text="人員編號、卡號"></asp:Label>
                        </th>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>                         
                        ...
                        <td>
                            <input type="text" name="PsnNo" id="PsnNo" value="" style="width:120px"/>
                        </td>
                        <td>
