<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReaderParaPop.aspx.cs" Inherits="SahoAcs.ReaderParaPop" EnableEventValidation="false" %>
                        ...
                        <fieldset id="ReaderPara_List" runat="server" style="width: 440px">
                            ...
                            <table border="0" class="Table04">
                                ...
                                <tr>
                                    <td>&nbsp </td>
                                    <td style="border-bottom: 1px solid #FFF;">
                                        <asp:Label ID="popL_LBlockLength" runat="server" Text="WIEGAND 輸出的BITs" Font-Bold="true"></asp:Label>
                                    </td>
                                    <td style="border-bottom: 1px solid #FFF;">
                                ...
                                <tr>
                                    <td style="text-align: center">
                                       <%-- <asp:TextBox ID="popInput_BlockLength" runat="server" Width="20px" Style="text-align: center"></asp:TextBox>--%>
                                        <select id="BlockLength" name="BlockLength" style="width:80px" class="DropDownListStyle" onchange="GetBlockLengthStr()">
                                            <%for (int i = 0; i < 64; i++)
                                                { %>
                                ...
                                <tr>
                                    <td></td>
                                    <td colspan="2">
                                        <asp:Label ID="pop_BlockLengthRemind" runat="server" Text="設定值為0 ~ 63。" Font-Size="13px" Width="300px" ForeColor="#BFFFEF"></asp:Label>
                                    </td>
                                </tr>
                                <%--斷行--%>
                                <tr style="height: 15px">
                                ...
                                <tr>
                                    <td style="text-align: center">
                                       <%-- <asp:TextBox ID="popInput_Buzzer" runat="server" Width="20px" Style="text-align: center"></asp:TextBox>--%>
                                        <select id="Buzzer" name="Buzzer" style="width:80px" onchange="GetBuzzerStr()" class="DropDownListStyle">
