<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryAbnormal.aspx.cs" Inherits="SahoAcs.Web._0679.QueryAbnormal" %>
    ...
    <table class="Item">
        <tr>
            <td>
                <table>
                    <tr>
                        <th class="ShowPsnInfo" colspan="3">
                            <span class="Arrow01"></span>
                            <asp:Label ID="Label1" runat="server" Text="日期區間"></asp:Label>
                        </th>         
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_CardNo_PsnName" runat="server" Text="卡號、人員編號"></asp:Label>
                        </th>
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_EquNo" runat="server" Text="設備編號"></asp:Label>
                        </th>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="ShowPsnInfo">
                            <input type="text" id="PsnCardNo" name="PsnCardNo" style="width:200px" value="" />
                        </td>          
                        <td class="ShowPsnInfo">
                            <asp:DropDownList ID="ddlEquNo" runat="server" Width="150px">
                            </asp:DropDownList>
                        </td>                                                                     
                        <td>
