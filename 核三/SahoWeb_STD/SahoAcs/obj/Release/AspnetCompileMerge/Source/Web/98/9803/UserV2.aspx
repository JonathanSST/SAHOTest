<%@ Page Language="C#" CodeBehind="UserV2.aspx.cs" Inherits="SahoAcs.UserV2" MasterPageFile="~/Site1.Master" Debug="true" AutoEventWireup="true" EnableEventValidation="false" Theme="UI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="MainDataArea" style="width:100%;overflow-x:scroll">
        <table class="TableS1" style="width: 1450px">
            <tbody>
                <tr class="GVStyle">
                    <th scope="col" style="width: 80px;"><%=GetLocalResourceObject("ttUserID") %></th>
                    <th scope="col" style="width: 80px;"><%=GetLocalResourceObject("ttUserName") %></th>
                    <th scope="col" style="width: 120px;"><%=GetLocalResourceObject("ttUserEName") %></th>
                    <th scope="col" style="width: 160px;"><%=GetLocalResourceObject("ttUserEmail") %></th>
                    <th scope="col" style="width: 90px;"><%=GetLocalResourceObject("ttOptAllow") %></th>
                    <th scope="col" style="width: 90px;"><%=GetLocalResourceObject("ttUserSTime") %></th>
                    <th scope="col" style="width: 90px;"><%=GetLocalResourceObject("ttUserETime") %></th>
                    <th scope="col" style="width: 100px;"><%=GetLocalResourceObject("ttPWChgTime") %></th>
                    <th scope="col" style="width: 140px;"><%=GetLocalResourceObject("ttUserPWCtrl") %></th>
                    <th scope="col" style=""><%=GetLocalResourceObject("ttRemark") %></th>
                </tr>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>                                
                                ...
                                <input type="hidden" id="msgRegRule" value="<%=this.GetLocalResourceObject("ttRule") %>" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <table id="ContentPlaceHolder1_popUserMgasAuthTable" class="Panel01" cellspacing="0" border="1" style="border-collapse: collapse; word-break: break-all;">
                            <tbody>
                                ...
                                <tr style="height: 30px;">
                                    ...
                                    <td style="text-align: center">
                                        <input id="UserMgaAuth" type="radio" name="UserMgaAuth" tabindex="0" value="<%=mga.MgaID %>" style="width:25px;height:25px" /></td>
                                </tr>
                                <%} %>
                            </tbody>
                        </table>
