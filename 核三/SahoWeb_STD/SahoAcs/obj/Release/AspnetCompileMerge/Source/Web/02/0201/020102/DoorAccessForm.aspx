<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoorAccessForm.aspx.cs" Inherits="SahoAcs.Web._02._0201._020102.DoorAccessForm" %>
        ...
        <table class="popItem">            
            ...
            <tr>
                <td style="text-align: center">
                    <input type="button" value="儲存" class="IconSave" onclick="SaveDoorAccess()"/>
                    <input type="button" value="取消" class="IconCancel" onclick="CancelOne()"/>
                </td>
            </tr>
        </table>        
