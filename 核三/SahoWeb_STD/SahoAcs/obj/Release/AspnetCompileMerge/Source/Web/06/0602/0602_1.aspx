<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="0602_1.aspx.cs" Inherits="SahoAcs._0602_1" %>
                ...
                <table>
                    <tr>
                        ...
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_CardNo_PsnName" runat="server" Text="身份證號碼"></asp:Label>
                        </th>
                        <th>
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_LogStatus" runat="server" Text="類型"></asp:Label>
                        </th>
                    ...
                    <tr>
                        ...
                        <td  class="ShowPsnInfo">                            
                            <input type="text" id="CardNoPsnNo" name="CardNoPsnNo" style="width:200px" value="<%=this.txt_CardNo_PsnName %>" readonly="readonly" />
                        </td>
                        <td style="font-size:16px;color:white">
                            <input type="radio" value="All" name="EquClass" checked="checked" /><span onclick="SetCheck(this)">全部資料</span>
                            <input type="radio" value="TRT" name="EquClass" /><span onclick="SetCheck(this)">出勤記錄</span>
                            <input type="radio" value="Door" name="EquClass" /><span onclick="SetCheck(this)">門禁資料</span>
                        </td>                        
                        <td class="ShowPsnInfo">
