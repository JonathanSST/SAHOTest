<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Theme="UI"
    CodeBehind="QueryCheckAlive.aspx.cs" Inherits="SahoAcs.Web._04._0404.QueryCheckAlive" %>
            ...
            <tbody>
                <tr class="GVStyle">
                    ...
                    <th scope="col" style="width: 40px;">
                        <span id="ContentPlaceHolder1_MainGridView_HeaderSubmitState" style="font-weight: bold;">連線狀態</span>
                    </th>
                    <th scope="col">
                        <span id="ContentPlaceHolder1_MainGridView_HeaderResponseState" style="font-weight: bold;">最後時間</span>
                    </th>
                </tr>
                <tr>
                                ...
                                <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" 
                                    ...
                                    <tbody id="list_each">                                        
                                        <tr id="GVRow_57" onmouseover="onMouseMoveIn(0, this, '', '');" v-for="item in items" onclick="CheckOpen(this)"
                                            ...
                                            <td align="center" style="width: 44px;" v-show="item.EquDesc==1">
                                                連線
                                            </td>
                                            <td align="center" style="width: 44px;color:red" v-show="item.EquDesc==0">
                                                斷線
                                            </td>
                                            <td>
    ...
    <table cellspacing="5" style="padding-top: 10px">
        <tr>
            <td>
                ...
                <input type="button" id="btnSend" value="更新" class="IconTransit" onclick="SendData()" />                
            </td>
            <td>
