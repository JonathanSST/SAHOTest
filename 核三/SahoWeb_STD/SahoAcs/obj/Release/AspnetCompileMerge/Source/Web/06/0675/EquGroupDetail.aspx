<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EquGroupDetail.aspx.cs" Inherits="SahoAcs.Web._0675.EquGroupDetail" %>
                ...
                <table>
                    <tr>
                        <th class="ShowPsnInfo">
                            ...
                            <asp:Label ID="QueryLabel_CardNo_PsnName" runat="server" Text="設備編號或群組編號名稱"></asp:Label>
                        </th>
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_Dept" runat="server" Text="設備群組"></asp:Label>
                        </th>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="ShowPsnInfo">
                            <input type="text" id="EquGrpNo" name="EquGrpNo" style="width:200px" value="" />
                        </td>          
                        <td class="ShowPsnInfo">
                            <asp:DropDownList ID="ddlEquGrpNo" runat="server" Width="150px">
                            </asp:DropDownList>
                        </td>                                                                     
                        <td>
