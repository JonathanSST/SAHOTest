<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryMobileLog.aspx.cs" Inherits="SahoAcs.QueryMobileLog" %>
        ...
        <tr>
            <td>
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="text" value="" id="EmpName" name="EmpName" style="width:90%" />
                        </td>
                        <td>
