<%@ Page Language="C#" Inherits="SahoAcs.QueryCardLogByType" MasterPageFile="~/Site1.Master" Debug="true" 
    AutoEventWireup="true" EnableEventValidation="false" Theme="UI" CodeBehind="QueryCardLogByType.aspx.cs" %>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <th>
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_LogType" runat="server" Text="記錄類型"></asp:Label>
                        </th>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="QueryLogType" runat="server" style="width:99%">                                
                                <asp:ListItem Value="D" Enabled="true">門禁</asp:ListItem>
                                <asp:ListItem Value="A">考勤</asp:ListItem>
                                <asp:ListItem Value="B">崗哨</asp:ListItem>
                                <asp:ListItem Value="C">教育訓練</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            &nbsp;</td>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="Label2" runat="server" Text="記錄類型" ReadOnly="True"></asp:Label>                                            
                                        </th>
                                        <th>
                                        </th>
                                        <th></th>
                                    ...
                                    <tr>
                                        <td>                                            
                                            <asp:DropDownList ID="ADV_LogType" runat="server" style="width:99%">
                                                <asp:ListItem Value="D" Enabled="true">門禁</asp:ListItem>
                                                <asp:ListItem Value="A">考勤</asp:ListItem>
                                                <asp:ListItem Value="B">崗哨</asp:ListItem>
                                                <asp:ListItem Value="C">教育訓練</asp:ListItem>
