<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="0603_1.aspx.cs" Inherits="SahoAcs._0603_1" %>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="ShowPsnInfo">
                            <input type="text" id="CardNo" name="CardNo" style="width: 200px" value="" />
                        </td>
                        <td class="ShowPsnInfo">
                            <input type="text" id="PsnNo" name="PsnNo" style="width: 200px" value="" />
                        </td>
                        <td class="ShowPsnInfo">
