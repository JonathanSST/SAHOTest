<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Elevator.aspx.cs" Inherits="SahoAcs.Elevator" EnableEventValidation="false" Theme="UI" %>
                ...
                <table class="Item">
                    <tr>
                        <th><span class="Arrow01"></span>
                            <asp:Label ID="Label_Building" runat="server" Text="<%$Resources:ResourceCtrls,Build %>"></asp:Label></th>
                        <th><span class="Arrow01"></span>
                            <asp:Label ID="Label_EquNo" runat="server" Text="<%$Resources:ResourceCtrls,EquNo %>"></asp:Label></th>
                        <th><span class="Arrow01"></span>
                            <asp:Label ID="Label_EquName" runat="server" Text="<%$Resources:ResourceCtrls,EquName %>"></asp:Label></th>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="Input_EquNo" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="Input_EquName" runat="server"></asp:TextBox></td>
                        <td>
            ...
            <tr>
                <td>
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="popInput_Building" runat="server" Width="320px" CssClass="TextBoxRequired"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
