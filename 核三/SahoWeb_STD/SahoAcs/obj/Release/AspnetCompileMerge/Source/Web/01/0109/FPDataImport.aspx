<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master"  CodeBehind="FPDataImport.aspx.cs" Inherits="SahoAcs.FPDataImport" Debug="true" EnableEventValidation="false" Theme="UI" %>
        ...
        <tr>
            <td>
                <fieldset id="PsnCard_List" runat="server" style="width: 880px">
                    <legend id="PsnCard_Legend" runat="server">指紋離線建檔資料匯入</legend>
                    <table>
                        <tr>
                            <td>
                                <asp:FileUpload ID="FileUpload_FPData" runat="server" Width="300px" Font-Size="20px" />
                            </td>
                            <td>
                                 <asp:Button ID="FPData_ImportButton" runat="server" Text="確定匯入" OnClick="FPData_ImportButton_Click" CssClass="IconImport"/>
                            </td>                            
                        </tr>
                    </table>
                </fieldset>
