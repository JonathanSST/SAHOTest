...
function ReJoinSchedule() {
    ...
    var DefArr = new Array();
    $('[name*="ClassNoAdj"]').serializeArray().map(function (item) {
        DefArr.push(item.value);
    });
    CheckSessionStatus().then(function (answer) {
        if (answer) {
            $.ajax({
                type: "POST",
                url: window.location.url,
                data: { 'ClassMonth': $('#ClassMonth').val(), 'PsnNo': $('#PsnNo').val(), 'PageEvent': 'JoinClass', 'ClassNoDef': DefArr.join(",") },
                //contentType: "application/json",
                dataType: "json",
                success: function (data) {
                    if (data.success === true) {
        ...
        if (answer) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#ModifyAdjArea").html($(data).find("#ModifyAdjArea").html());
