<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardFloor2.aspx.cs" Inherits="SahoAcs.CardFloor2" Debug="true" EnableEventValidation="false" Theme="UI" %>
...
<body>
    <form id="form1" runat="server">
                            ...
                            <asp:Panel ID="tablePanel1" runat="server" ScrollBars="Vertical" Width="390px" Height="315px">
                                ...
                                <asp:GridView runat="server" ID="GridView1" SkinID="GridViewSkin" Width="100%" PageSize="5"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IOIndex" HeaderText="IO點" SortExpression="IOIndex" />
                                        <asp:BoundField DataField="FloorName" HeaderText="樓層名稱" SortExpression="FloorName" />
                                    </Columns>
                                </asp:GridView>
                            </asp:Panel>
                        </td>
        ...
        <table style="border-collapse: collapse">
            ...
            <tr>
                <td>
                    <asp:Button ID="BtSave" runat="server" Text="確定" OnClick="BtSave_Click" CssClass="IconOk" /></td>
                <td>
                    <asp:Button ID="BtCancel" runat="server" Text="取消" CssClass="IconCancel" />
                </td>
            </tr>
        </table>
