<%@ Page Language="C#" Inherits="SahoAcs._0601_2" MasterPageFile="~/Site1.Master" Debug="true" 
    AutoEventWireup="true" EnableEventValidation="false" Theme="UI" CodeBehind="0601_2.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <td>
                <table>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 16px; color: white"><%=GetGlobalResourceObject("Resource","lblTo") %></td>
                        <td>
                       ...
                       <%-- <td>
                        ...
                        <td id="ShowPsnInfo3" runat="server">
                        ...
                        <td>                            
                         ...
                         <td>
                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" RepeatLayout="Flow" Width="250px" Font-Size="Small" ForeColor="White">
                                <asp:ListItem Selected="True" Value="1">全部資料</asp:ListItem>
                                <asp:ListItem Value="2">出勤資料</asp:ListItem>
                                <asp:ListItem Value="3">門禁資料</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:HiddenField ID="hQueryMode" runat="server" EnableViewState="True" />
            <table class="TableS1">
                        ...
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight" Width="1600px">
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" Width="100%" PageSize="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TempCardNo" HeaderText="<%$Resources:ttTempCardNo %>" SortExpression="TempCardNo" />
    ...
    <div>
        ...
        <input type="button" name="PrintButton" value="列  印" id="PrintButton" class="IconExport" onclick="SetPrint()" />
    </div>
