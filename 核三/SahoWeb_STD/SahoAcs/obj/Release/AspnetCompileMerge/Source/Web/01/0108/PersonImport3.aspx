<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master"  CodeBehind="PersonImport3.aspx.cs" Inherits="SahoAcs.PersonImport3" Debug="true" EnableEventValidation="false" Theme="UI" %>
        ...
        <tr>
            <td>
                <fieldset id="PsnCard_List" runat="server" style="width: 880px">
                    <legend id="PsnCard_Legend" runat="server">人員卡片資料匯入</legend>
                    <table>
                        <tr>
                            <td>
