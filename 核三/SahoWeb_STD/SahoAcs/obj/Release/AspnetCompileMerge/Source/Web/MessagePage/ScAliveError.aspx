<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScAliveError.aspx.cs" Inherits="SahoAcs.Web.MessagePage.ScAliveError" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="text-align: center; font-weight: normal; font-size: xx-large; width: 100%; color: blue; font-family:微軟正黑體;">
                ...
                <tr>
                    <td style="height: 135px"><%="SC 狀態出現異常，請稍候再進行系統操作!!" %></td>
                </tr>
                <tr>
                    <td>
