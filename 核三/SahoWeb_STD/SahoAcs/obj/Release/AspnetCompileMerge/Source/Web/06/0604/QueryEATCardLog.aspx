<%@ Page Language="C#" Inherits="SahoAcs.QueryEATCardLog" MasterPageFile="~/Site1.Master" Debug="true" AutoEventWireup="true" EnableEventValidation="false" Theme="UI" CodeBehind="QueryEATCardLog.aspx.cs" %>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <th>
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_LogStatus" runat="server" Text="讀卡結果"></asp:Label>
                        </th>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
            ...
            <table class="TableS1">
                ...
                <tr>
                    <td id="td_showGridView" runat="server" style="padding: 0">
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight" Width="1750px">
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" PageSize="5"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DepID" HeaderText="部門代碼" SortExpression="DepID" />
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <th style="text-align: right; width: 20%">
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADV_Label_LogStatus" runat="server" Text="讀卡結果"></asp:Label>
                                        </th>
