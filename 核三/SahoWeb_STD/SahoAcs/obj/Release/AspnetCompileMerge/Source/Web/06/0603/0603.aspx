<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="0603.aspx.cs" Inherits="SahoAcs._0603" %>

<%@ Register Src="/uc/CalendarFrm.ascx" TagName="CalendarFrm" TagPrefix="uc2" %>
<%@ Register Src="~/uc/MultiSelectDropDown.ascx" TagPrefix="uc3" TagName="MultiSelectDropDown" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="ValueKeep">
        ...
        <input type="hidden" id="oDepID" name="oDepID" value="" />
    </div>
    <table class="Item">
        <tr>
            <td>
                <table>
                    <tr>
                        ...
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_CardNo_PsnName" runat="server" Text="<%$Resources:ttCardNo %>"></asp:Label>
                        </th>
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="Label1" runat="server" Text="<%$Resources:ttPsnNo %>"></asp:Label>
                        </th>
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_Dept" runat="server" Text="單位"></asp:Label>
                        </th>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="ShowPsnInfo">
                            <input type="text" id="CardNo" name="CardNo" style="width: 150px" value="" />
                        </td>
                        <td class="ShowPsnInfo">
                            <input type="text" id="PsnNo" name="PsnNo" style="width: 150px" value="" />
                        </td>
                        <td class="ShowPsnInfo" style="width:210px">
                            <%--<asp:DropDownList ID="ddlDept" runat="server" Width="200px">
                            </asp:DropDownList>--%>
                            <uc3:MultiSelectDropDown runat="server" ID="DropDownList_Company" ListWidth="200" ListHeight="300" />
                        </td>
                        <td>
    ...
    <div>
        ...
        <input type="button" name="ExportButton" value="列　印" id="PdfButton" class="IconExport" onclick="SetPdf()" />
    </div>
</asp:Content>
