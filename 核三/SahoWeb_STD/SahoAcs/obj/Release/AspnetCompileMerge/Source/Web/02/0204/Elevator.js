...
// 執行新增動作
function AddExcute() {
    PageMethods.Insert(hideUserID.value, popInput_Building.value, popInput_EquModel.value, popInput_EquNo.value, popInput_EquName.value, popInput_EquEName.value, popInput_Dci.value, popInput_CardNoLen.value, Excutecomplete, onPageMethodsError);
}
...
function SetUI(DataArray) {
    if (DataArray[0] != 'Saho_SysErrorMassage') {
        ...
        popInput_EquModel.value = DataArray[1];
        popInput_EquNo.value = DataArray[2];
        popInput_EquName.value = DataArray[3];
        popInput_EquEName.value = DataArray[4];
        popInput_Dci.value = DataArray[5];
        popInput_CardNoLen.value = DataArray[6];
    }
    else {
...
// 執行編輯動作
function EditExcute() {
    PageMethods.Update(hideUserID.value, SelectValue.value, popInput_Building.value, popInput_EquModel.value, popInput_EquNo.value, popInput_EquName.value, popInput_EquEName.value, popInput_Dci.value, popInput_CardNoLen.value, Excutecomplete, onPageMethodsError);
}
