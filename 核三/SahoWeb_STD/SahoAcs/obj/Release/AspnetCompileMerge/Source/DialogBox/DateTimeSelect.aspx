<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DateTimeSelect.aspx.cs" Inherits="SahoAcs.DialogBox.DateTimeSelect" %>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="text-align:right">
                                    ...
                                    <input type="hidden" value="<%=this.DateTimeNow %>" id="para_date" />
                                </td>
                            </tr>
                        </table>
                    </td>
