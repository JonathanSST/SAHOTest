<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master"  CodeBehind="MemberImport.aspx.cs" Inherits="SahoAcs.MemberImport" Debug="true" EnableEventValidation="false" Theme="UI" %>
        ...
        <tr>
            <td>
                <fieldset id="PsnCard_List" runat="server" style="width: 880px">
                    <legend id="PsnCard_Legend" runat="server">閱卷委員資料匯入</legend>
                    <table>
                        <tr>
                            <td>
