<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CardEquAdj3.aspx.cs" Inherits="SahoAcs.CardEquAdj2" Debug="true" EnableEventValidation="false" Theme="UI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="Item">
        <tr>
            <th>
                <span class="Arrow01"></span>條件：
                <asp:DropDownList ID="ddl_input" runat="server" Width="100px">
                    <asp:ListItem Value="Card">卡片</asp:ListItem>
                    <asp:ListItem Value="Org">組織</asp:ListItem>
                    <asp:ListItem Value="No">工號</asp:ListItem>
                    <asp:ListItem Value="Name">姓名</asp:ListItem>
                </asp:DropDownList>
                <asp:Button ID="btSelectData" runat="server" Text="選取資料" CssClass="IconChoose" />
            </th>
        </tr>
    </table>
    <table border="0" class="Item">
        <tr>
            <th style="width: 260px">
                <span class="Arrow01"></span>資料列表：
            </th>
            <th>
                <span class="Arrow01"></span>設備權限列表：
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnSearch" runat="server" Text="選取權限資料" OnClick="btnSearch_Click" CssClass="IconChoose" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
                                ...
                                <tr>
                                    <td>
                                        <fieldset id="Pending_List" runat="server" style="width: 300px; height: 300px">
                                            <legend id="Pending_Legend" runat="server">待加入</legend>
                                                                ...
                                                                <asp:Panel ID="tablePanel2" runat="server" ScrollBars="Vertical" Width="300px" Height="250px">
                                                                    ...
                                                                    <asp:GridView runat="server" ID="GridView2" SkinID="GridViewSkin" PageSize="5"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="CardRule" HeaderText="規則" SortExpression="CardRule" />
                                                                ...
                                                                <asp:Panel ID="tablePanel2_Grp" runat="server" ScrollBars="Vertical" Width="300px" Height="250px" Visible="false">
                                                                    ...
                                                                    <asp:GridView runat="server" ID="GridView4" SkinID="GridViewSkin" PageSize="5"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="EquNo" HeaderText="群組編號" SortExpression="EquNo" />
                                                                            <asp:BoundField DataField="EquName" HeaderText="群組名稱" SortExpression="EquName" />
                                                                            <asp:BoundField DataField="CardRule" HeaderText="規則" SortExpression="CardRule" />
                                                                            <asp:BoundField DataField="Floor" HeaderText="樓層" SortExpression="Floor" />
                                                                            <asp:BoundField DataField="EquID" HeaderText="ID" SortExpression="EquID" />
                                                                        </Columns>
                                    ...
                                    <td>
                                        <fieldset id="Queue_List" runat="server" style="width: 550px; height: 300px">
                                            <legend id="Queue_Legend" runat="server">已加入</legend>
                                                                ...
                                                                <asp:Panel ID="tablePanel1" runat="server" ScrollBars="Vertical" Width="550px" Height="250px">
                                                                    ...
                                                                    <asp:GridView runat="server" ID="GridView1" SkinID="GridViewSkin" PageSize="5"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                                                <HeaderTemplate>
                                                                                    <asp:Label ID="CardRule" runat="server" Text="規則"></asp:Label>
                                                                                </HeaderTemplate>
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                                                <HeaderTemplate>
                                                                                    <asp:Label ID="Floor" runat="server" Text="電梯"></asp:Label>
                                                                                </HeaderTemplate>
                                                                                <ItemTemplate>
                                        ...
                                        <table border="0" class="Item" style="margin-top: 10px">
                                            <tr>
                                                <th>
                                                    ...
                                                    <asp:Label ID="Label1" runat="server" Text="作業類型："></asp:Label>
                                                </th>
                                                <td></td>
                                                <td></td>
                                                <td></td>
