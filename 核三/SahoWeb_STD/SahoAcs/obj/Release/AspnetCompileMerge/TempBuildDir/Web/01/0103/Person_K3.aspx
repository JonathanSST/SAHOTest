<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Person_K3.aspx.cs" Inherits="SahoAcs.Person_K3" Debug="true" EnableEventValidation="false" Theme="UI" %>
                    ...
                    <table class="Item">
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    <asp:Label ID="lblPsnRule" runat="server" Text="<%$ Resources:lblPsnRule %>"></asp:Label>
                                </div>
                                <div>
                                    <asp:DropDownList ID="Input_PsnRule" runat="server" >
                                 ...
                                 <div>
                                    <asp:Label ID="lblPsnLock" runat="server" Text="<%$ Resources:lblPsnLock %>"></asp:Label>
                                </div>
                                <div>
                                    <asp:DropDownList ID="Input_PsnLock" runat="server" >
                                        <asp:ListItem Value="0" Selected="True" Text="<%$Resources:SelectNO %>"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="<%$Resources:SelectYES %>"></asp:ListItem>                                        
                                    </asp:DropDownList>
                                </div>
