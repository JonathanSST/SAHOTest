<%@ Page Language="C#" AutoEventWireup="True" Inherits="SahoAcs.Web.MessagePage.ChangePWAlert" CodeBehind="ChangePWAlert.aspx.cs" %>
                    ...
                    <tr>
                        <td>
                            <table cellspacing="5" style="font-family: 微軟正黑體,Arial; font-size: 14px; color: black; text-align: left">
                                ...
                                <tr>
                                    <td colspan="3">
                                        <asp:Label ID="Label_Remind" runat="server" Text="密碼原則：密碼則a-z、0~9組成，必需6碼以上"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
