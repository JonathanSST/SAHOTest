<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OrgStruc.aspx.cs" Inherits="SahoAcs.OrgStruc" Debug="true" EnableEventValidation="false" Theme="UI" %>
    ...
    <table style="width: 850px">
                ...
                <table class="Item">
                    ...
                    <tr>
                        ...
                        <td style="width: 500px">
                            <asp:TextBox ID="Input_Condition" runat="server" Width="98%"></asp:TextBox></td>
                        <td></td>
                        <td>
        ...
        <tr>
            <td>
                ...
                <asp:HiddenField ID="hFlagRowCount" runat="server" EnableViewState="False" />
