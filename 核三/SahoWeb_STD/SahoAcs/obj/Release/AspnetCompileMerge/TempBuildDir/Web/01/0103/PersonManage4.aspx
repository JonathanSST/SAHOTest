<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"  Theme="UI"  CodeBehind="PersonManage4.aspx.cs" Inherits="SahoAcs.Web.PersonManage4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../../scripts/Check/JS_CHECK.js?<%=DateTime.Now.ToString("yyyyMMddHHmmss") %>" type="text/javascript"></script>
      ...
      <table class="Item">
        ...
        <tr>
            <td>
                ...
                <select style="width: 200px" class="DropDownListStyle" id="CompanyList">
            ...
            <td>
                <select style="width: 200px" class="DropDownListStyle" id="DeptList">
                    <option value=""><%=Resources.Resource.ddlSelectDefault %></option>
                        ...
                        <table class="Item">
                            <tr>
                                <td style="vertical-align: top; width: 250px;">
                                    ...
                                    <div>
                                        <input type="text" name="PsnNo" id="PsnNo" style="width:180px" must_keyin_yn="Y" field_name="人員編號" value="<%=this.PersonObj.PsnNo %>" />
                                    </div>
                                    <div>
                                ...
                                <td style="vertical-align:top;width:250px">
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <span id="ContentPlaceHolder1_lblPersonEmail"><%=GetLocalResourceObject("lblPersonal") %></span>
                                     </div>
                                     <div>
                                        <input type="text" name="Personal"  id="Personal" style="width:200px" must_keyin_yn="Y" field_name="個人電子郵件" value="<%=this.PersonObj.Personal %>" />
                                     </div>
                                     <div>
                                        <span id="ContentPlaceHolder1_lblDirectEMail"><%=GetLocalResourceObject("lblSupervisor") %></span>
                                     </div>
                                    <div>
                                        <input type="text" name="Supervisor" id="Supervisor" style="width:200px" must_keyin_yn="Y" field_name="主管電子郵件" value="<%=this.PersonObj.Supervisor %>" /> 
                                    </div>
                                    ※如有多組E-Mail，請用 , 隔開
