<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ItineraryDay.aspx.cs" Inherits="SahoAcs.ItineraryDay" %>
                    ...
                    <tr>
                        <td>
                            <select id="DeptNo" name="DeptNo" class="DropDownListStyle" style="width:120px">
                                ...
                                <%foreach (var o in this.OrgDatas)
                                    { %>
