<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExtError.aspx.cs" Inherits="SahoAcs.Web.MessagePage.ExtError" EnableViewStateMac="true" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="text-align: center; font-weight: normal; font-size: xx-large; width: 100%; color: blue; font-family:微軟正黑體;">
                ...
                <tr>
                    <td style="height: 135px"><%=this.ErrorMessage %></td>
                </tr>
                <tr>
                    <td>
