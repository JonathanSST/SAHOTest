<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Person2.aspx.cs" Inherits="SahoAcs.Person2" Debug="true" EnableEventValidation="false" Theme="UI" %>
                    ...
                    <table class="Item">
                        <tr>
                            ...
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    <asp:TextBox ID="Input_CardVer" runat="server" Width="90px"></asp:TextBox>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p style="height: 3px">&nbsp;</p>
                                    <input type="button" class="IconChange" value="變更卡號" id="btnChange" name="btnChange" onclick="ChangeCard2(2)" />
                                </div>                            
                            </td>
                            ...
                            <td>
                                <table style="padding: 0px; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:TextBox ID="popInput_CardVer" runat="server" Width="70px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th colspan="4">
