$(document).ready(function () {
    $("#BtnQuery").click(function () {
        ...
        $.post("QueryStayLog4.aspx",
     {
         ...
         "EquDir": $('[name*="EquDir"]:eq(0)').val(),
         "Range": $('[name*="Range"]:eq(0)').val(),
         "PageEvent": "Query", "Builds": $('[name*="Builder"]:eq(0)').val(),
         "Calendar1": $('[name*="Calendar"]:eq(0)').val()
     }
     , function (data) {
