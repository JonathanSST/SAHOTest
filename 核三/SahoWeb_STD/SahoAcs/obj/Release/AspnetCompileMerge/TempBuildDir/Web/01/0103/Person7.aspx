<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Person7.aspx.cs" Inherits="SahoAcs.Person7" Debug="true" EnableEventValidation="false" Theme="UI" %>
                    ...
                    <table class="Item">
                        <tr>
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    <asp:TextBox ID="Input_PsnNo" runat="server" Width="180px" MaxLength="6" MUST_KEYIN_YN="Y" FIELD_NAME="人員編號"></asp:TextBox>
                                </div>
                                <div>
