<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CourseManage.aspx.cs" Inherits="SahoAcs.CourseManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table>
                    <tr>
                        <th>
                            ...
                            <asp:Label ID="QueryLabel_CardTime" runat="server" Text="課程編號"></asp:Label>
                        </th>
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_CardNo_PsnName" runat="server" Text="課程名稱"></asp:Label>
                        </th>                        
                        <th class="ShowPsnInfo">
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_Dept" runat="server" Text="所在縣市"></asp:Label>
                        </th>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" id="QueryNo" name="QueryNo"/>
                        </td>
                        <td class="ShowPsnInfo">
                            <input type="text" id="QueryName" name="QueryName"/>
                        </td>
                        <td class="ShowPsnInfo">
                            <select name="QueryCity" id="QueryCity" class="DropDownListStyle" style="width: 240px">
                                ...
                                <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        ...
                                        <%foreach (System.Data.DataRow r in this.DataResult.Rows)
                                            { %>
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" onclick="SingleRowSelect(0, this, SelectValue,'199158', '', '');" style="color: rgb(0, 0, 0);" ondblclick="SetEdit('<%=r["CourseID"].ToString() %>')">
                                            <td style="width:104px">
                                                <input type="button" name="ButtonEdit" value="編  輯" id="ButtonEdit" onclick="SetEdit('<%=r["CourseID"].ToString() %>')" class="IconSet" />
                                            </td>
    ...
    <div>
        ...
        <input type="button" name="ButtonAdd" value="新增" id="ButtonAdd" class="IconNew" tabindex="0" onclick="SetAdd()" />
    </div>
</asp:Content>
