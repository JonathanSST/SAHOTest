<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PersonCardFill.aspx.cs" Inherits="SahoAcs.PersonCardFill" %>
                                ...
                                <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        ...
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">                                                                                        
                                            ...
                                            <td>                                                
                                                <input type="button" class="IconSet" value="進廠" onclick="OpenDoor('<%=o.PsnID%>','1')" />
                                                <input type="button" class="IconSet" value="出廠" onclick="OpenDoor('<%=o.PsnID%>','2')" />
                                            </td>                                            
                                        </tr>
                                        <%} %>
                                    </tbody>
