...
function SetUI(DataArray) {
    if (DataArray[0] != 'Saho_SysErrorMassage') {
        ...
        ADV_TextBox_ComName.value   = DataArray[1];
        ADV_TextBox_DepName.value   = DataArray[2];
        ADV_TextBox_PsnName.value   = DataArray[3];
        ADV_TextBox_PsnNo.value     = DataArray[4];
        ADV_TextBox_CardNo.value    = DataArray[5];
        ADV_TextBox_EquNo.value     = DataArray[6];
        ADV_TextBox_EquName.value   = DataArray[7];
        ADV_TextBox_LogStatus.value = DataArray[8];
        ADV_TextBox_DepNo.value     = DataArray[9];
        ADV_TextBox_CardVer.value   = DataArray[10];
        ADV_TextBox_LogTime.value   = DataArray[11];
    }
    else {
