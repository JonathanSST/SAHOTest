<%@ Page Language="C#" Inherits="SahoAcs.QueryCardLog_old20180109" MasterPageFile="~/Site1.Master" Debug="true" 
    AutoEventWireup="true" EnableEventValidation="false" Theme="UI" CodeBehind="QueryCardLog_old20180109.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table class="TableS1">
                ...
                <tr>
                    <td id="td_showGridView" runat="server">
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight" Width="1370px">
    ...
    <div>
        ...
        <asp:Button ID="ExportButton" OnClick="ExportButton_Click" runat="server" Text="<%$Resources:Resource,btnExport %>" CssClass="IconExport" />
    </div>
