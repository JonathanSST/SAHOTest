<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="0603_3.aspx.cs" Inherits="SahoAcs._0603_3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ContentPlaceHolder1_UpdatePanel1">
        <table class="TableS1">
            <tbody>
                <tr class="GVStyle">
                    <th scope="col" style="width:50px;"><input type="checkbox" style="width:25px;height:25px" name="ChkAll" id="ChkAll" onclick="SetCheckAll(this)" /></th>
                    <th scope="col" style="width:120px;">讀卡時間</th>
                    <th scope="col" style="width: 120px;">單位部門</th>
                    <th scope="col" style="width: 80px;">工號</th>
                    <th scope="col" style="width: 80px;">姓名</th>
                    <th scope="col" style="width: 80px;">卡號</th>
                    <th scope="col" style="width: 80px;">臨時卡號</th>                    
                    <th scope="col" style="width: 60px;">卡片版次</th>
                    <th scope="col" style="width: 80px;">設備編號</th>
                    <th scope="col" style="width: 100px;">設備名稱</th>
                    <th scope="col">讀卡結果</th>                    
                </tr>
                <tr>
                                ...
                                <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        ...
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">
                                            <td style="width:54px;text-align:center"><input type="checkbox" style="width:25px;height:25px" name="ChkOne" id="ChkOne" value="<%=o.RecordID %>" /></td>
                                            ...
                                            <td style="width: 84px;"><%=o.PsnName %></td>
                                            <td style="width: 84px;"><%=o.IDNum %></td>
                                            <td style="width: 84px;"><%=o.TempCardNo %></td>
    ...
    <br />
    <div>        
        <input type="button" name="BtnReSend" value="重新拋轉" id="BtnReSend" class="IconExport" onclick="ReSend()" />
    </div>
