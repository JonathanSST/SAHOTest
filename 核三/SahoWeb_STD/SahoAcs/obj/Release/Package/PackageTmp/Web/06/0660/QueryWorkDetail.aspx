<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryWorkDetail.aspx.cs" Inherits="SahoAcs.QueryWorkDetail" %>
            ...
            <tbody>
                ...
                <tr>
                    <td id="ContentPlaceHolder1_td_showGridView" colspan="15">
                        <div id="ContentPlaceHolder1_tablePanel" class="MinHeight" style="width: 1600px; overflow-y: scroll;">
                            <div id="DivSaveArea">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">          
                                            ...
                                            <td style="width:144px">
                                                <%=string.Join("<br/>", o.StartTime.Split(','))%>
                                            </td>
                                            <td style="width:144px">
                                                <%=string.Join("<br/>", o.EndTime.Split(','))%>
                                                </td>
                                            <td style="width:84px">
                                                <%=o.Daily %>
                                                </td>
                                            ...
                                            <td style="width:84px">
                                                <%=string.Join("<br/>", o.StatuDesc.Split(','))%>
                                            </td>                              
                                            <td>                                                
