<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ESDCardLogByGarmin.aspx.cs" Inherits="SahoAcs.ESDCardLogByGarmin" %>
            ...
            <td>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <uc2:MultiSelectDropDown runat="server" ID="DropDownList_LogStatus" ListWidth="150" ListHeight="50" />
                        </td>                        
                        <td class="ShowPsnInfo">
