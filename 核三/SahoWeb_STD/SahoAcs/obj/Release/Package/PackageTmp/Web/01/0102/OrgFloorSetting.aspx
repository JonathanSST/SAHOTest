<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgFloorSetting.aspx.cs" Inherits="SahoAcs.OrgFloorSetting" Theme="UI" EnableEventValidation="false" %>
            ...
            <table border="0">
                    ...
                    <td style="height: 450px; width:620px; vertical-align: top" id="EquArea">
                        <fieldset id="Fieldset3" runat="server" style="width: 580px; height: 430px">
                            <legend id="Legend3" runat="server">
                                <asp:Label ID="Label4" runat="server"><%=this.GetLocalResourceObject("ttElevCtrl") %>(<%=Request["equ_name"].ToString() %>)</asp:Label>
                            </legend>                            
                            <table class="TableS1">
                                <tbody>
                                    <tr class="GVStyle">                                        
                ...
                <tr>
                    <td style="text-align: center">      
                        ...
                        <input type="hidden" value="<%=Request["equ_index"] %>" id="EquIndex" />
