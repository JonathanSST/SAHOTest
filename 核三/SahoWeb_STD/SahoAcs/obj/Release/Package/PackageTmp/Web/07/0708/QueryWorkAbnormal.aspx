<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryWorkAbnormal.aspx.cs" Inherits="SahoAcs.Web._07._0708.QueryWorkAbnormal" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">          
                                           ...
                                           <%-- <td style="width:54px">
                                            ...
                                            <td>                                                
                                                <input type="text" value="<%=o.Remark %>" id="Remark" name="Remark" style="width:98%" />
