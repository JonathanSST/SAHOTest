<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Theme="UI"
    CodeBehind="QueryCardLogSpec5.aspx.cs" Inherits="SahoAcs.Web.QueryCardLogSpec5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="TableS1" style="width: 1150px">
        <tbody>
            <tr class="GVStyle">
               <th scope="col" style="width: 115px;">投票時間</th>
                ...
                <th scope="col" style="width: 110px;">設備名稱</th>
                <th scope="col" style="width: 110px;">廠商</th>
                <th scope="col">結果</th>                
            </tr>
            <tr>
                        ...
                        <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                            <tbody>
                                ...
                                <tr id="GV_Row1" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)">
                                    ...
                                    <td style="width: 74px"><%=o.PsnName %></td>
                                    <td style="width: 84px"><%=o.CardNo %></td>
                                    <td style="width: 84px"><%=o.EquNo %></td>
                                    <td style="width: 114px"><%=o.EquName %></td>
                                    <td style="width: 114px"><%=o.MgaName %></td>
                                    <td><%=o.EquName.Contains("(右)")?"滿意":"不滿意" %></td>                                    
                                </tr>
                                <%} %>
                            </tbody>
                        </table>
