<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="ImportData2.aspx.cs" Inherits="SahoAcs.ImportData2" Debug="true" EnableEventValidation="false" Theme="UI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="Item">
        <tr>
            <td>
                <fieldset id="ReaderPara_List" runat="server" style="width: 880px">
        ...
        <tr>
            <td>
                <fieldset id="EquGrop_List" runat="server" style="width: 880px">
                ...
                <fieldset id="OrgStruc_List" runat="server" style="width:880px">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="CleanTable_OrgStruc" runat="server" Text="清空資料表" OnClientClick="Block()" Font-Size="Small" OnClick="CleanTable_OrgStruc_Click" CssClass="IconDelete" />
                            </td>
                            <td>
