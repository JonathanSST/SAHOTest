<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryMeal0601.aspx.cs" Inherits="SahoAcs.QueryMeal0601" %>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <th>
                            <span class="Arrow01"></span>
                            <asp:Label ID="Label1" runat="server" Text="讀卡機編號"></asp:Label>
                        </th>
                        <th>
                            <span class="Arrow01"></span>
                            <asp:Label ID="QueryLabel_LogStatus" runat="server" Text="供應廠商"></asp:Label>
                        </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropEquNo" runat="server" Width="150px" CssClass="DropDownListStyle">
                             </asp:DropDownList>
                        </td>
                        <td>
                            <asp:DropDownList ID="DropMgaList" runat="server" Width="150px" CssClass="DropDownListStyle">
                             </asp:DropDownList>
                        </td>                        
                        <td class="ShowPsnInfo">
