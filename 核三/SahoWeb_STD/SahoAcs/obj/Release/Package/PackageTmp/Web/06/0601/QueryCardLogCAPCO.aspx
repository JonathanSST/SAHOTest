<%@ Page Language="C#" Inherits="SahoAcs.QueryCardLogCAPCO" MasterPageFile="~/Site1.Master" Debug="true" AutoEventWireup="true" EnableEventValidation="false" Theme="UI" CodeBehind="QueryCardLogCAPCO.aspx.cs" %>
            ...
            <table class="TableS1">
                ...
                <tr>
                    <td id="td_showGridView" runat="server">
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight" Width="1898px">
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" Width="100%" PageSize="5" EnableViewState="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CompName" HeaderText="公司" SortExpression="CompName" />
                                    ...
                                    <asp:BoundField DataField="CtrlName" HeaderText="控制器" SortExpression="CtrlName" />
                                    <asp:BoundField DataField="LogEquGrpName" HeaderText="設備群組" SortExpression="LogEquGrpName" />
                                ...
                                <PagerTemplate>
                                    ...
                                    <asp:PlaceHolder ID="phdCardLogCount" runat="server"></asp:PlaceHolder>
                                </PagerTemplate>
                            </asp:GridView>
                        </asp:Panel>
                    </td>
    ...
    <asp:Panel ID="PanelPopup1" runat="server" SkinID="PanelPopup" Width="650px" EnableViewState="False" CssClass="PopBg">
        <asp:Panel ID="PanelDrag1" runat="server" SkinID="PanelDrag" EnableViewState="False">
            <table class="TableWidth">
                <tr>
                    <td>
                        <asp:Label ID="L_popName1" runat="server" Text="檢視讀卡資料" Font-Bold="True" ForeColor="White"
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADV_Label_ComName" runat="server" Text="公司"></asp:Label>
                                        </th>
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADV_Label_DepName" runat="server" Text="部門"></asp:Label>
                                        </th>
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADV_Label_PsnName" runat="server" Text="人員"></asp:Label>
                                        </th>
                                        <th>
                                            <span class="Arrow01"></span>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_ComName" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_DepName" runat="server" ReadOnly="true" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_PsnName" runat="server" ReadOnly="true" Enabled="false" Width="100px"></asp:TextBox>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_CardNo" runat="server" ReadOnly="true" Enabled="false" Width="100px"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_EquNo" runat="server" ReadOnly="true" Enabled="false" Width="100px"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_EquName" runat="server" ReadOnly="true" Enabled="false" Width="200px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table class="TableWidth">
                                    <tr>
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADV_Label_DepNo" runat="server" Text="控制器"></asp:Label>
                                        </th>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_DepNo" runat="server" ReadOnly="true" Enabled="false" Width="200px"></asp:TextBox>
                                        </td>
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADV_Label_CardVer" runat="server" Text="設備群組"></asp:Label>
                                        </th>
                                        <td>
                                            <asp:TextBox ID="ADV_TextBox_CardVer" runat="server" ReadOnly="true" Enabled="false" Width="200px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><font color="White" size="4">至</font></td>
                                        <td>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADVQueryLabel_DepNoDepName" runat="server" Text="公司部門代碼或名稱"></asp:Label>
                                        </th>
                                        <th>
                                            <span class="Arrow01"></span>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <th>
                                            <span class="Arrow01"></span>
                                            <asp:Label ID="ADVQueryLabel_LogStatus" runat="server" Text="刷卡結果"></asp:Label>
                                        </th>
                                    </tr>
                                    <tr>
