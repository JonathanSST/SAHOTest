<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryPsnEquAuthFillLog.aspx.cs" 
    Inherits="SahoAcs.QueryPsnEquAuthFillLog" EnableEventValidation="false" Theme="UI" %>
                        ...
                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Vertical" CssClass="MinHeight">
                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" PageSize="5"
                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="<%$Resources:ttEquNo %>" SortExpression="ttEquNo">
                                        <ItemTemplate>                                            
                                            <asp:LinkButton ID="BtnFillLog" runat="server" EnableViewState="false">
                                                <%# DataBinder.Eval(Container.DataItem, "EquNo") %>
                                            </asp:LinkButton>                                            
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="EquName" HeaderText="<%$Resources:ttEquNo %>" SortExpression="EquName" />
                                </Columns>
                                <PagerTemplate>
