<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="0603Rpt.aspx.cs" Inherits="SahoAcs.Web._06._0603._0603Rpt" %>
...
<body>
    ...
    <div>
        ...
        <table  style="border-style: solid; border-width: 0px; border-collapse: collapse">
            <tr class="dataclass">
    ...
    <%
        ...
        if (this.ListLog.Count > 0)
        {
            ...
            for (int p = 1; p <= PageData.PageCount; p++)
            {
                ...
                sb.Append(string.Format("<table style='width:100%;font-size:10pt'><tr><td style='width:50%'>刷卡時間區間：{0}~{1}</td></tr></table>",Request["CardTimeS"],Request["CardTimeE"], ""));
        ...
        Response.AddHeader("content-disposition", "attachment;filename=考工讀卡記錄報表.pdf");
        Response.End();
         %>
</body>
</html>
