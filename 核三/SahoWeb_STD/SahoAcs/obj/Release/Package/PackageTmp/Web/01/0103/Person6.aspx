<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Person6.aspx.cs" Inherits="SahoAcs.Person6" Debug="true" EnableEventValidation="false" Theme="UI" %>
                                        ...
                                        <asp:Panel ID="tablePanel" runat="server" ScrollBars="Auto" Height="470px" Width="450px">
                                            ...
                                            <asp:GridView runat="server" ID="MainGridView" SkinID="GridViewSkin" PageSize="5"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="IDNum" HeaderText="卡號" SortExpression="IDNum" />
                    ...
                    <table class="Item">
                        <tr>
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    <asp:TextBox ID="Input_PsnNo" runat="server" Width="180px" MaxLength="10" MUST_KEYIN_YN="Y" FIELD_NAME="人員編號"></asp:TextBox>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:TextBox ID="Input_PsnPW" runat="server" Width="180px" TextMode="Password" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </td>
                            <td style="vertical-align: top; width: 250px;">
                                <%--<div>
                            ...
                            <td style="vertical-align: top; width: 250px;">
                                ...
                                <div>
                                    ...
                                    <%--<p style="height: 3px">&nbsp;</p>
                                    <input type="button" class="IconChange" value="變更卡號" id="btnChange" name="btnChange" onclick="ChangeCard2(1)" />--%>
                                </div>                            
                            </td>
                    ...
                    <table class="Item">
                        <tr>
                            <td colspan="4" style="text-align: center; width: 1250px;">
                                ...
                                <input type="button" id="btResetPwd" name="btResetPwd" value="重設密碼" onclick="ResetPwd()" class="IconSet"/>
