<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStayZZ03.aspx.cs" Inherits="SahoAcs.QueryStayZZ03" %>
            ...
            <td>
                <table>
                    ...
                    <tr>     
                        ...
                        <%--<td>
                            <select class="DropDownListStyle" id="InOutType" name="InOutType" style="width:108px">
                                <option value="進">在宿</option>
                                <option value="出">未在宿</option>
                            </select>
                        </td>--%>
                        <td>                            
    ...
    <div id="ContentPlaceHolder1_UpdatePanel1">
        <table class="TableS1" style="width:1050px">
            <tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="DataRow" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">                                            
                                            <td style="width:124px">
                                                <%--<%=o.InOutDate.Substring(0,4)+"/"+o.InOutDate.Substring(4,2)+"/"+o.InOutDate.Substring(6,2) %>  --%>
                                                <%=o.InOutDate %>
                                            </td>
                                            ...
                                            <td>
                                                <%=o.InTime!=null?o.InTime.Value.ToString("HH:mm:ss"):"" %>
                                            </td>
                                        </tr>
                                        <%} %>
                                    </tbody>
                ...
                <tr class="GVStyle">
                     <td colspan="11">
                         <%=string.Format("總筆數：{0}",this.ListLog.Count) %>
                    </td>                    
                </tr>
            </tbody>
        </table>
