<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" 
    CodeBehind="QueryWorkMonth.aspx.cs" Inherits="SahoAcs.Web._06._0673.QueryWorkMonth" %>
                ...
                <table>
                    ...
                    <tr>
                       <td>
                        ...
                        <td>                            
                            <input type="button" class="IconSearch" value="<%=GetGlobalResourceObject("Resource","btnQuery") %>" onclick="DoRefresh()" />
                        </td>
                    </tr>
                </table>
            </td>
