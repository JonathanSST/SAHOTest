<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PsnItineraryLog.aspx.cs" Inherits="SahoAcs.PsnItineraryLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table class="TableS1" style="width: 1150px">
            <tbody>
                <tr class="GVStyle">
                    ...
                    <th scope="col" class="TitleRow" style="width: 105px">打卡時間
                    </th>
                    <th scope="col" class="TitleRow" style="width: 320px">打卡地點
                    </th>
                    <th scope="col" class="TitleRow" style="width:100px">兩地距離
                    </th>
                    <th scope="col" class="TitleRow" style="width:140px">打卡座標
                    </th>
                     <th scope="col" class="TitleRow" style="">開啟地圖
                    </th>
                </tr>
                <tr>
                                ...
                                <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        ...
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">
                                            ...
                                            <td style="width: 109px">
                                                <%=o.LocalTime.Value.ToString("HH:mm:ss") %>
                                            </td>
                                            ...
                                            <td style="width:144px">
                                                    <%=string.Format("{0}, {1}", o.Oplatitude,o.OpLongitude) %>
                                            </td>
                                            <td style="">
    ...
    <div id="ShowLogMap" style="width: 50%; height: 50%; display: none; position: absolute; z-index: 30000; background-color: #1275BC; border-style: solid; border-width: 2px; border-color: #069">
        <table>
            <tr>
                <td>
                    <input type="button" name="btnCloseMap" id="btnCloseMap" value="關閉" class="IconCancel" onclick="CancelOneLogArea()" />
                </td>
            </tr>
        </table>
    </div>
