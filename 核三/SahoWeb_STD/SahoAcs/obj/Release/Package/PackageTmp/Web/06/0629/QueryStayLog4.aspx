<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" Theme="UI"
    CodeBehind="QueryStayLog4.aspx.cs" Inherits="SahoAcs.Web.QueryStayLog4" %>
...
<%@ Register src="../../../uc/CalendarFrm.ascx" tagname="CalendarFrm" tagprefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ValueKeep">
        ...
        <input type="hidden" id="EquDir" name="EquDir" value="出" />
            ...
            <td>
                <table>
                    ...
                    <tr>                        
                        ...
                        <td>
                            <uc3:CalendarFrm ID="CalendarFrm1" runat="server" />
                        </td>                                                
                        <td>
                        ...
                        <table class="GVStyle" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_MainGridView" style="width: 100%; border-collapse: collapse;">
                            <tbody>
                                ...
                                <tr id="GV_Row1" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)">
                                    ...
                                    <td><%=this.OutList.Where(i=>i.PsnNo.Trim()==o.PsnNo).Count()>0?"已申請請假":"未申請" %></td>
                                </tr>
                                <%} %>
                            </tbody>
                        </table>
