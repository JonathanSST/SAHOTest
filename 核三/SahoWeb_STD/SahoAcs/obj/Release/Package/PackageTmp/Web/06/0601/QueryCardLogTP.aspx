<%@ Page Title="" Theme="UI" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryCardLogTP.aspx.cs" Inherits="SahoAcs.QueryCardLogTP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ValueKeep">
        ...
        <asp:HiddenField ID="ChkLogStatus" runat="server" EnableViewState="False" />
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <th>
                            <span class="Arrow01" style="display:none"></span>
                                        ...
                                        <tr class="DataRow" id="GV_Row199158" onmouseover="onMouseMoveIn(0,this,'','')" onmouseout="onMouseMoveOut(0,this)" style="color: rgb(0, 0, 0);">
                                            ...
                                            <td>
                                                <% if((c.ColName != "CardTimeVal")) { %> 
                                                        <% if(r[c.ColName].ToString() ==this.ChkLogStatus.Value) { %> 
                                                                  <a href="#" onclick="SetCardStatus(<%=r["RecordID"].ToString() %>)"><%=r[c.ColName].ToString() %></a>
...
<div id="dialog-form" title="選擇出勤狀況"   style="display:none">
 <select id="select_op" >
    ...
    <input id="CardlogSave" onclick="CardLogSave()" class="IconSave" type="button" value="確定" />
</div>
