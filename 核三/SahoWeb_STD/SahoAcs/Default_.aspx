...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default_.aspx.cs" Inherits="SahoAcs.Default_" EnableViewStateMac="true" %>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <ul>
                    ...
                    <li>
                        ...
                        <asp:HiddenField ID="ClientToken" runat="server" />
                    </li>
                </ul>
                <ul>
                    <li>
                ...
                <h2>
                    <asp:Button ID="btnLogin" runat="server" Text="<%$ Resources:Resource, btnLogin %>" OnClick="btnLogin_Click" CssClass="BtnLogin" />
                </h2>
                <div style="color: cornsilk; font-size: 20px; text-align: center;">                    
                    <%=Resources.Resource.lblBrowserAlarm %>
                </div>
